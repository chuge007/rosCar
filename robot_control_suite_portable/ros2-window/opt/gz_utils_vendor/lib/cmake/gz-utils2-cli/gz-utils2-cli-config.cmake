# - Config file for the gz-utils2-cli component
#
# This should only be invoked by gz-utils2-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-utils2 COMPONENTS cli)
#
# This creates the following targets:
#
#   Component library target                - gz-utils2::gz-utils2-cli
#   Alternative target name                 - gz-utils2::cli
...
# this is discouraged:
#
#   gz-utils2-cli_LIBRARY  - Component library (actually contains gz-utils2::cli)
#
# We will also set gz-utils2-cli_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-utils2-cli_CONFIG_INCLUDED)
  return()
endif()
set(gz-utils2-cli_CONFIG_INCLUDED TRUE)

if(NOT gz-utils2-cli_FIND_QUIETLY)
  message(STATUS "Looking for gz-utils2-cli -- found version 2.2.1")
endif()
...
# dependencies.
if(gz-utils2-cli_FIND_REQUIRED)
...
if(NOT gz-utils2-cli_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-utils2-cli")
endif()

# --------------------------------

if(NOT TARGET gz-utils2::gz-utils2-cli)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-utils2-cli-targets.cmake")

  # Create a simplified imported target name for the cli library.
  # You can link to this target instead of the cli library.
  add_library(gz-utils2::cli INTERFACE IMPORTED)
  set_target_properties(gz-utils2::cli PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-utils2::gz-utils2-cli")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-utils2::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-utils2::gz-utils2-cli")
endif()

set(gz-utils2-cli_LIBRARY gz-utils2::gz-utils2-cli)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-utils2-cli "gz-utils2-cli")
