...
[[deprecated("use nav_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const nav_msgs::srv::LoadMap_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  nav_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use nav_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const nav_msgs::srv::LoadMap_Event & msg)
{
  return nav_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<nav_msgs::srv::LoadMap_Event>()
{
  return "nav_msgs::srv::LoadMap_Event";
}

template<>
inline const char * name<nav_msgs::srv::LoadMap_Event>()
{
  return "nav_msgs/srv/LoadMap_Event";
}

template<>
struct has_fixed_size<nav_msgs::srv::LoadMap_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<nav_msgs::srv::LoadMap_Event>
  : std::integral_constant<bool, has_bounded_size<nav_msgs::srv::LoadMap_Request>::value && has_bounded_size<nav_msgs::srv::LoadMap_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<nav_msgs::srv::LoadMap_Event>
  : std::true_type {};
