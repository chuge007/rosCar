...
#ifndef NAV_MSGS__SRV__DETAIL__GET_MAP__TYPE_SUPPORT_H_
#define NAV_MSGS__SRV__DETAIL__GET_MAP__TYPE_SUPPORT_H_
...
#endif  // NAV_MSGS__SRV__DETAIL__GET_MAP__TYPE_SUPPORT_H_
