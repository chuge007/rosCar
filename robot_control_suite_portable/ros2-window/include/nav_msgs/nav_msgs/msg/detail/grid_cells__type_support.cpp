...
void fetch_function__GridCells__cells(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Point *>(
    get_const_function__GridCells__cells(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Point *>(untyped_value);
  value = item;
}

void assign_function__GridCells__cells(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Point *>(
    get_function__GridCells__cells(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GridCells_message_member_array[4] = {
  ...
  },
  {
    ...
    fetch_function__GridCells__cells,  // fetch(index, &value) function pointer
    assign_function__GridCells__cells,  // assign(index, value) function pointer
