...
void builtin_interfaces__msg__Duration__rosidl_typesupport_introspection_c__Duration_init_function(
...
void builtin_interfaces__msg__Duration__rosidl_typesupport_introspection_c__Duration_fini_function(void * message_memory)
{
  builtin_interfaces__msg__Duration__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember builtin_interfaces__msg__Duration__rosidl_typesupport_introspection_c__Duration_message_member_array[2] = {
  {
    "sec",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers builtin_interfaces__msg__Duration__rosidl_typesupport_introspection_c__Duration_message_members = {
...
static rosidl_message_type_support_t builtin_interfaces__msg__Duration__rosidl_typesupport_introspection_c__Duration_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, builtin_interfaces, msg, Duration)() {
  if (!builtin_interfaces__msg__Duration__rosidl_typesupport_introspection_c__Duration_message_type_support_handle.typesupport_identifier) {
    builtin_interfaces__msg__Duration__rosidl_typesupport_introspection_c__Duration_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &builtin_interfaces__msg__Duration__rosidl_typesupport_introspection_c__Duration_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
