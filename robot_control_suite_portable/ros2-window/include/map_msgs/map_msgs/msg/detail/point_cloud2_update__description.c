  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xdc, 0x9e, 0xc6, 0xad, 0x32, 0xc0, 0x91, 0x74,
      0x11, 0x23, 0x25, 0xb7, 0x2b, 0xef, 0x1b, 0x6c,
      0x76, 0xb8, 0x0a, 0xbd, 0x84, 0x2d, 0xe4, 0x3c,
      0x66, 0x90, 0x92, 0x15, 0xe5, 0x21, 0x48, 0x7c,
    }};
  return &hash;
}
...
static char map_msgs__msg__PointCloud2Update__TYPE_NAME[] = "map_msgs/msg/PointCloud2Update";
...
static char map_msgs__msg__PointCloud2Update__FIELD_NAME__header[] = "header";
static char map_msgs__msg__PointCloud2Update__FIELD_NAME__type[] = "type";
static char map_msgs__msg__PointCloud2Update__FIELD_NAME__points[] = "points";

static rosidl_runtime_c__type_description__Field map_msgs__msg__PointCloud2Update__FIELDS[] = {
  {
    {map_msgs__msg__PointCloud2Update__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {map_msgs__msg__PointCloud2Update__FIELD_NAME__type, 4, 4},
    {
  ...
  {
    {map_msgs__msg__PointCloud2Update__FIELD_NAME__points, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription map_msgs__msg__PointCloud2Update__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {map_msgs__msg__PointCloud2Update__TYPE_NAME, 30, 30},
      {map_msgs__msg__PointCloud2Update__FIELDS, 3, 3},
    },
    {map_msgs__msg__PointCloud2Update__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
...
map_msgs__msg__PointCloud2Update__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *map_msgs__msg__PointCloud2Update__get_individual_type_description_source(NULL),
