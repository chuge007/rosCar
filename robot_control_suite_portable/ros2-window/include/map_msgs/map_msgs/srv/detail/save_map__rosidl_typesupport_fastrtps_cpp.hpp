...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_map_msgs
cdr_serialize(
  const map_msgs::srv::SaveMap_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  map_msgs::srv::SaveMap_Event & ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_map_msgs
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, map_msgs, srv, SaveMap_Event)();
