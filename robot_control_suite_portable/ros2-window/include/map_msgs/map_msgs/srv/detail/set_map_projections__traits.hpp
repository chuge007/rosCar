...
inline void to_flow_style_yaml(
  const SetMapProjections_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const SetMapProjections_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use map_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const map_msgs::srv::SetMapProjections_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  map_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use map_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const map_msgs::srv::SetMapProjections_Event & msg)
{
  return map_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<map_msgs::srv::SetMapProjections_Event>()
{
  return "map_msgs::srv::SetMapProjections_Event";
}

template<>
inline const char * name<map_msgs::srv::SetMapProjections_Event>()
{
  return "map_msgs/srv/SetMapProjections_Event";
}

template<>
struct has_fixed_size<map_msgs::srv::SetMapProjections_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<map_msgs::srv::SetMapProjections_Event>
  : std::integral_constant<bool, has_bounded_size<map_msgs::srv::SetMapProjections_Request>::value && has_bounded_size<map_msgs::srv::SetMapProjections_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<map_msgs::srv::SetMapProjections_Event>
  : std::true_type {};
