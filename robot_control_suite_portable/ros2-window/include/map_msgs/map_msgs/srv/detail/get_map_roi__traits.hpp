...
[[deprecated("use map_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const map_msgs::srv::GetMapROI_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  map_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use map_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const map_msgs::srv::GetMapROI_Event & msg)
{
  return map_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<map_msgs::srv::GetMapROI_Event>()
{
  return "map_msgs::srv::GetMapROI_Event";
}

template<>
inline const char * name<map_msgs::srv::GetMapROI_Event>()
{
  return "map_msgs/srv/GetMapROI_Event";
}
