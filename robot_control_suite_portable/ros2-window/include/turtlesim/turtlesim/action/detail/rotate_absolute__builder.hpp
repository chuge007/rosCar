...
{
public:
  explicit Init_RotateAbsolute_SendGoal_Event_response(::turtlesim::action::RotateAbsolute_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::turtlesim::action::RotateAbsolute_SendGoal_Event response(::turtlesim::action::RotateAbsolute_SendGoal_Event::_response_type arg)
  {
...
private:
  ::turtlesim::action::RotateAbsolute_SendGoal_Event msg_;
};

class Init_RotateAbsolute_SendGoal_Event_request
{
public:
  explicit Init_RotateAbsolute_SendGoal_Event_request(::turtlesim::action::RotateAbsolute_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_RotateAbsolute_SendGoal_Event_response request(::turtlesim::action::RotateAbsolute_SendGoal_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_RotateAbsolute_SendGoal_Event_request info(::turtlesim::action::RotateAbsolute_SendGoal_Event::_info_type arg)
  {
...
template<>
inline
auto build<::turtlesim::action::RotateAbsolute_SendGoal_Event>()
{
  return turtlesim::action::builder::Init_RotateAbsolute_SendGoal_Event_info();
}
...
{
public:
  explicit Init_RotateAbsolute_GetResult_Event_response(::turtlesim::action::RotateAbsolute_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::turtlesim::action::RotateAbsolute_GetResult_Event response(::turtlesim::action::RotateAbsolute_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::turtlesim::action::RotateAbsolute_GetResult_Event msg_;
};

class Init_RotateAbsolute_GetResult_Event_request
{
public:
  explicit Init_RotateAbsolute_GetResult_Event_request(::turtlesim::action::RotateAbsolute_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_RotateAbsolute_GetResult_Event_response request(::turtlesim::action::RotateAbsolute_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_RotateAbsolute_GetResult_Event_request info(::turtlesim::action::RotateAbsolute_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
...
template<>
inline
auto build<::turtlesim::action::RotateAbsolute_GetResult_Event>()
{
  return turtlesim::action::builder::Init_RotateAbsolute_GetResult_Event_info();
}
