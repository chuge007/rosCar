...
bool cdr_serialize_turtlesim__msg__Color(
  const turtlesim__msg__Color * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
bool cdr_deserialize_turtlesim__msg__Color(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
bool cdr_serialize_key_turtlesim__msg__Color(
  const turtlesim__msg__Color * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
size_t get_serialized_size_key_turtlesim__msg__Color(
  const void * untyped_ros_message,
  size_t current_alignment);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
size_t max_serialized_size_key_turtlesim__msg__Color(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
