...
// IWYU pragma: private, include "pendulum_msgs/msg/joint_state.h"


#ifndef PENDULUM_MSGS__MSG__DETAIL__JOINT_STATE__FUNCTIONS_H_
#define PENDULUM_MSGS__MSG__DETAIL__JOINT_STATE__FUNCTIONS_H_
 ...
 * calls
 * pendulum_msgs__msg__JointState__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pendulum_msgs
pendulum_msgs__msg__JointState *
pendulum_msgs__msg__JointState__create(void);

/// Destroy msg/JointState message.
/**
 * It calls
 * pendulum_msgs__msg__JointState__fini()
 ...
 * pendulum_msgs__msg__JointState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * pendulum_msgs__msg__JointState__Sequence__fini()
 * on the array,
...
#endif  // PENDULUM_MSGS__MSG__DETAIL__JOINT_STATE__FUNCTIONS_H_
