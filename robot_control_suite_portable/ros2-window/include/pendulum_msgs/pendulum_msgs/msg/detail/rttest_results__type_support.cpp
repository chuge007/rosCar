...
void RttestResults_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) pendulum_msgs::msg::RttestResults(_init);
}

void RttestResults_fini_function(void * message_memory)
{
  auto typed_message = static_cast<pendulum_msgs::msg::RttestResults *>(message_memory);
  typed_message->~RttestResults();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RttestResults_message_member_array[9] = {
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<pendulum_msgs::msg::JointCommand>(),  // members of sub message
    false,  // is key
    false,  // is array
    0,  // array size
    false,  // is upper bound
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<pendulum_msgs::msg::JointState>(),  // members of sub message
    false,  // is key
    false,  // is array
    0,  // array size
    false,  // is upper bound
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RttestResults_message_members = {
  ...
  9,  // number of fields
  sizeof(pendulum_msgs::msg::RttestResults),
  false,  // has_any_key_member_
  RttestResults_message_member_array,  // message members
  RttestResults_init_function,  // function to initialize message memory (memory has to be allocated)
  RttestResults_fini_function  // function to terminate message instance (will not free memory)
};
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pendulum_msgs, msg, RttestResults)() {
  return &::pendulum_msgs::msg::rosidl_typesupport_introspection_cpp::RttestResults_message_type_support_handle;
}
