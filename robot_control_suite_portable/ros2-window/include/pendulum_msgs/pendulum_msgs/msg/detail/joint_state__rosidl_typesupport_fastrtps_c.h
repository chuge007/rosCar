...
#ifndef PENDULUM_MSGS__MSG__DETAIL__JOINT_STATE__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
#define PENDULUM_MSGS__MSG__DETAIL__JOINT_STATE__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
...
bool cdr_serialize_pendulum_msgs__msg__JointState(
  const pendulum_msgs__msg__JointState * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pendulum_msgs
bool cdr_deserialize_pendulum_msgs__msg__JointState(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pendulum_msgs
bool cdr_serialize_key_pendulum_msgs__msg__JointState(
  const pendulum_msgs__msg__JointState * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pendulum_msgs
size_t get_serialized_size_key_pendulum_msgs__msg__JointState(
  const void * untyped_ros_message,
  size_t current_alignment);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pendulum_msgs
size_t max_serialized_size_key_pendulum_msgs__msg__JointState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
#endif  // PENDULUM_MSGS__MSG__DETAIL__JOINT_STATE__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
