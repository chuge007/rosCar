...
void WrenchStamped_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) geometry_msgs::msg::WrenchStamped(_init);
}

void WrenchStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<geometry_msgs::msg::WrenchStamped *>(message_memory);
  typed_message->~WrenchStamped();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WrenchStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(geometry_msgs::msg::WrenchStamped),
  false,  // has_any_key_member_
  WrenchStamped_message_member_array,  // message members
  WrenchStamped_init_function,  // function to initialize message memory (memory has to be allocated)
  WrenchStamped_fini_function  // function to terminate message instance (will not free memory)
};
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, geometry_msgs, msg, WrenchStamped)() {
  return &::geometry_msgs::msg::rosidl_typesupport_introspection_cpp::WrenchStamped_message_type_support_handle;
}
