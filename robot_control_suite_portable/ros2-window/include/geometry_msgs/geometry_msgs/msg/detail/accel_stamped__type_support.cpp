...
void AccelStamped_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) geometry_msgs::msg::AccelStamped(_init);
}

void AccelStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<geometry_msgs::msg::AccelStamped *>(message_memory);
  typed_message->~AccelStamped();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AccelStamped_message_members = {
  ...
  AccelStamped_init_function,  // function to initialize message memory (memory has to be allocated)
  AccelStamped_fini_function  // function to terminate message instance (will not free memory)
};
