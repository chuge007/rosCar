...
inline void to_flow_style_yaml(
  const AccelWithCovarianceStamped & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
...
inline std::string to_yaml(const AccelWithCovarianceStamped & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const geometry_msgs::msg::AccelWithCovarianceStamped & msg)
{
