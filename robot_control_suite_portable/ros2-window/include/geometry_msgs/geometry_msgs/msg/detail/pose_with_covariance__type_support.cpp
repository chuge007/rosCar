...
void fetch_function__PoseWithCovariance__covariance(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__PoseWithCovariance__covariance(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__PoseWithCovariance__covariance(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__PoseWithCovariance__covariance(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PoseWithCovariance_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__PoseWithCovariance__covariance,  // fetch(index, &value) function pointer
    assign_function__PoseWithCovariance__covariance,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
