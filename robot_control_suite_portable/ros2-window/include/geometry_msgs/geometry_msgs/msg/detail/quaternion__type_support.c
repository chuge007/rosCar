...
static rosidl_typesupport_introspection_c__MessageMember geometry_msgs__msg__Quaternion__rosidl_typesupport_introspection_c__Quaternion_message_member_array[4] = {
  {
    "x",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers geometry_msgs__msg__Quaternion__rosidl_typesupport_introspection_c__Quaternion_message_members = {
...
static rosidl_message_type_support_t geometry_msgs__msg__Quaternion__rosidl_typesupport_introspection_c__Quaternion_message_type_support_handle = {
  0,
