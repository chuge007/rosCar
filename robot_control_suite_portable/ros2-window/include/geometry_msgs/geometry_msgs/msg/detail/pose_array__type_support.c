...
void * geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__get_function__PoseArray__poses(
  ...
  const void * untyped_member, size_t index, void * untyped_value)
{
  const geometry_msgs__msg__Pose * item =
    ...
    geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__get_const_function__PoseArray__poses(untyped_member, index));
  ...
  void * untyped_member, size_t index, const void * untyped_value)
{
  geometry_msgs__msg__Pose * item =
    ...
    geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__get_function__PoseArray__poses(untyped_member, index));
  const geometry_msgs__msg__Pose * value =
    (const geometry_msgs__msg__Pose *)(untyped_value);
  *item = *value;
}

bool geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__resize_function__PoseArray__poses(
...
static rosidl_typesupport_introspection_c__MessageMember geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__PoseArray_message_member_array[2] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__size_function__PoseArray__poses,  // size() function pointer
    geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__get_const_function__PoseArray__poses,  // get_const(index) function pointer
    geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__get_function__PoseArray__poses,  // get(index) function pointer
    geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__fetch_function__PoseArray__poses,  // fetch(index, &value) function pointer
    geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__assign_function__PoseArray__poses,  // assign(index, value) function pointer
    geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__resize_function__PoseArray__poses  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__PoseArray_message_members = {
...
static rosidl_message_type_support_t geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__PoseArray_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, PoseArray)() {
  ...
  if (!geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__PoseArray_message_type_support_handle.typesupport_identifier) {
    geometry_msgs__msg__PoseArray__rosidl_typesupport_introspection_c__PoseArray_message_type_support_handle.typesupport_identifier =
