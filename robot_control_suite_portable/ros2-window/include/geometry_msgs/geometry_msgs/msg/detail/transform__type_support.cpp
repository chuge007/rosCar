...
{
  new (message_memory) geometry_msgs::msg::Transform(_init);
}

void Transform_fini_function(void * message_memory)
{
  auto typed_message = static_cast<geometry_msgs::msg::Transform *>(message_memory);
  typed_message->~Transform();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Transform_message_member_array[2] = {
  {
    "translation",  // name
    ...
    offsetof(geometry_msgs::msg::Transform, translation),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(geometry_msgs::msg::Transform, rotation),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Transform_message_members = {
  ...
  2,  // number of fields
  sizeof(geometry_msgs::msg::Transform),
...
{
  return &::geometry_msgs::msg::rosidl_typesupport_introspection_cpp::Transform_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, geometry_msgs, msg, Transform)() {
  return &::geometry_msgs::msg::rosidl_typesupport_introspection_cpp::Transform_message_type_support_handle;
}
