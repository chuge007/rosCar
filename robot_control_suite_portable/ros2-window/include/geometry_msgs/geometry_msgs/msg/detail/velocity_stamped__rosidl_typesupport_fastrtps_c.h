...
#ifndef GEOMETRY_MSGS__MSG__DETAIL__VELOCITY_STAMPED__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
#define GEOMETRY_MSGS__MSG__DETAIL__VELOCITY_STAMPED__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
...
bool cdr_serialize_geometry_msgs__msg__VelocityStamped(
  const geometry_msgs__msg__VelocityStamped * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geometry_msgs
bool cdr_deserialize_geometry_msgs__msg__VelocityStamped(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geometry_msgs
bool cdr_serialize_key_geometry_msgs__msg__VelocityStamped(
  const geometry_msgs__msg__VelocityStamped * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geometry_msgs
size_t get_serialized_size_key_geometry_msgs__msg__VelocityStamped(
  const void * untyped_ros_message,
  size_t current_alignment);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geometry_msgs
size_t max_serialized_size_key_geometry_msgs__msg__VelocityStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
#endif  // GEOMETRY_MSGS__MSG__DETAIL__VELOCITY_STAMPED__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
