...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AccelWithCovarianceStamped_message_member_array[2] = {
  {
    ...
    offsetof(geometry_msgs::msg::AccelWithCovarianceStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(geometry_msgs::msg::AccelWithCovarianceStamped, accel),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AccelWithCovarianceStamped_message_members = {
...
static const rosidl_message_type_support_t AccelWithCovarianceStamped_message_type_support_handle = {
  ...
  &AccelWithCovarianceStamped_message_members,
...
{
  return &::geometry_msgs::msg::rosidl_typesupport_introspection_cpp::AccelWithCovarianceStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, geometry_msgs, msg, AccelWithCovarianceStamped)() {
  return &::geometry_msgs::msg::rosidl_typesupport_introspection_cpp::AccelWithCovarianceStamped_message_type_support_handle;
}
