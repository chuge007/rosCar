...
{
  new (message_memory) geometry_msgs::msg::Pose(_init);
}

void Pose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<geometry_msgs::msg::Pose *>(message_memory);
  typed_message->~Pose();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pose_message_member_array[2] = {
  {
    ...
    offsetof(geometry_msgs::msg::Pose, position),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(geometry_msgs::msg::Pose, orientation),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<geometry_msgs::msg::Pose>()
{
  return &::geometry_msgs::msg::rosidl_typesupport_introspection_cpp::Pose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, geometry_msgs, msg, Pose)() {
  return &::geometry_msgs::msg::rosidl_typesupport_introspection_cpp::Pose_message_type_support_handle;
}
