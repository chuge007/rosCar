...
void fetch_function__InteractiveMarker__menu_entries(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const visualization_msgs::msg::MenuEntry *>(
    get_const_function__InteractiveMarker__menu_entries(untyped_member, index));
  auto & value = *reinterpret_cast<visualization_msgs::msg::MenuEntry *>(untyped_value);
  value = item;
}

void assign_function__InteractiveMarker__menu_entries(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<visualization_msgs::msg::MenuEntry *>(
    get_function__InteractiveMarker__menu_entries(untyped_member, index));
  const auto & value = *reinterpret_cast<const visualization_msgs::msg::MenuEntry *>(untyped_value);
  item = value;
}
...
void fetch_function__InteractiveMarker__controls(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const visualization_msgs::msg::InteractiveMarkerControl *>(
    get_const_function__InteractiveMarker__controls(untyped_member, index));
  auto & value = *reinterpret_cast<visualization_msgs::msg::InteractiveMarkerControl *>(untyped_value);
  value = item;
}

void assign_function__InteractiveMarker__controls(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<visualization_msgs::msg::InteractiveMarkerControl *>(
    get_function__InteractiveMarker__controls(untyped_member, index));
  const auto & value = *reinterpret_cast<const visualization_msgs::msg::InteractiveMarkerControl *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember InteractiveMarker_message_member_array[7] = {
  ...
  },
  {
    ...
    fetch_function__InteractiveMarker__menu_entries,  // fetch(index, &value) function pointer
    assign_function__InteractiveMarker__menu_entries,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__InteractiveMarker__controls,  // fetch(index, &value) function pointer
    assign_function__InteractiveMarker__controls,  // assign(index, value) function pointer
