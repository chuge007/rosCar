...
void fetch_function__InteractiveMarkerControl__markers(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const visualization_msgs::msg::Marker *>(
    get_const_function__InteractiveMarkerControl__markers(untyped_member, index));
  auto & value = *reinterpret_cast<visualization_msgs::msg::Marker *>(untyped_value);
  value = item;
}

void assign_function__InteractiveMarkerControl__markers(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<visualization_msgs::msg::Marker *>(
    get_function__InteractiveMarkerControl__markers(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember InteractiveMarkerControl_message_member_array[8] = {
  ...
  },
  {
    ...
    fetch_function__InteractiveMarkerControl__markers,  // fetch(index, &value) function pointer
    assign_function__InteractiveMarkerControl__markers,  // assign(index, value) function pointer
