...
void visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_init_function(
...
void visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_fini_function(void * message_memory)
{
  visualization_msgs__msg__MenuEntry__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_message_member_array[5] = {
  {
    "id",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_message_members = {
...
static rosidl_message_type_support_t visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, visualization_msgs, msg, MenuEntry)() {
  if (!visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_message_type_support_handle.typesupport_identifier) {
    visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &visualization_msgs__msg__MenuEntry__rosidl_typesupport_introspection_c__MenuEntry_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
