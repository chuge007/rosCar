...
#define TEST_MSGS__ACTION__DETAIL__FIBONACCI__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_PUBLIC_test_msgs
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_msgs, action, Fibonacci_SendGoal)();
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_PUBLIC_test_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_msgs, action, Fibonacci_GetResult)();
...
#endif  // TEST_MSGS__ACTION__DETAIL__FIBONACCI__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
