...
{
public:
  explicit Init_Fibonacci_SendGoal_Event_response(::test_msgs::action::Fibonacci_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::test_msgs::action::Fibonacci_SendGoal_Event response(::test_msgs::action::Fibonacci_SendGoal_Event::_response_type arg)
  {
...
private:
  ::test_msgs::action::Fibonacci_SendGoal_Event msg_;
};

class Init_Fibonacci_SendGoal_Event_request
{
public:
  explicit Init_Fibonacci_SendGoal_Event_request(::test_msgs::action::Fibonacci_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_Fibonacci_SendGoal_Event_response request(::test_msgs::action::Fibonacci_SendGoal_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Fibonacci_SendGoal_Event_request info(::test_msgs::action::Fibonacci_SendGoal_Event::_info_type arg)
  {
...
template<>
inline
auto build<::test_msgs::action::Fibonacci_SendGoal_Event>()
{
  return test_msgs::action::builder::Init_Fibonacci_SendGoal_Event_info();
}
...
{
public:
  explicit Init_Fibonacci_GetResult_Event_response(::test_msgs::action::Fibonacci_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::test_msgs::action::Fibonacci_GetResult_Event response(::test_msgs::action::Fibonacci_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::test_msgs::action::Fibonacci_GetResult_Event msg_;
};

class Init_Fibonacci_GetResult_Event_request
{
public:
  explicit Init_Fibonacci_GetResult_Event_request(::test_msgs::action::Fibonacci_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_Fibonacci_GetResult_Event_response request(::test_msgs::action::Fibonacci_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Fibonacci_GetResult_Event_request info(::test_msgs::action::Fibonacci_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
...
template<>
inline
auto build<::test_msgs::action::Fibonacci_GetResult_Event>()
{
  return test_msgs::action::builder::Init_Fibonacci_GetResult_Event_info();
}
