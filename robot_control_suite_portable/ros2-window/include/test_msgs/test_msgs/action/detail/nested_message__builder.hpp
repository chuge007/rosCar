...
class Init_NestedMessage_SendGoal_Event_response
{
public:
  explicit Init_NestedMessage_SendGoal_Event_response(::test_msgs::action::NestedMessage_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::test_msgs::action::NestedMessage_SendGoal_Event response(::test_msgs::action::NestedMessage_SendGoal_Event::_response_type arg)
  {
...
private:
  ::test_msgs::action::NestedMessage_SendGoal_Event msg_;
};

class Init_NestedMessage_SendGoal_Event_request
{
public:
  explicit Init_NestedMessage_SendGoal_Event_request(::test_msgs::action::NestedMessage_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_NestedMessage_SendGoal_Event_response request(::test_msgs::action::NestedMessage_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_NestedMessage_SendGoal_Event_response(msg_);
  }
...
class Init_NestedMessage_SendGoal_Event_info
{
public:
  Init_NestedMessage_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_NestedMessage_SendGoal_Event_request info(::test_msgs::action::NestedMessage_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_NestedMessage_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::test_msgs::action::NestedMessage_SendGoal_Event>()
{
  return test_msgs::action::builder::Init_NestedMessage_SendGoal_Event_info();
}
...
class Init_NestedMessage_GetResult_Event_response
{
public:
  explicit Init_NestedMessage_GetResult_Event_response(::test_msgs::action::NestedMessage_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::test_msgs::action::NestedMessage_GetResult_Event response(::test_msgs::action::NestedMessage_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::test_msgs::action::NestedMessage_GetResult_Event msg_;
};

class Init_NestedMessage_GetResult_Event_request
{
public:
  explicit Init_NestedMessage_GetResult_Event_request(::test_msgs::action::NestedMessage_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_NestedMessage_GetResult_Event_response request(::test_msgs::action::NestedMessage_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_NestedMessage_GetResult_Event_response(msg_);
  }
...
class Init_NestedMessage_GetResult_Event_info
{
public:
  Init_NestedMessage_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_NestedMessage_GetResult_Event_request info(::test_msgs::action::NestedMessage_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_NestedMessage_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::test_msgs::action::NestedMessage_GetResult_Event>()
{
  return test_msgs::action::builder::Init_NestedMessage_GetResult_Event_info();
}
