...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Nested_message_member_array[1] = {
  {
    ...
    offsetof(test_msgs::msg::Nested, basic_types_value),  // bytes offset in struct
...
{
  return &::test_msgs::msg::rosidl_typesupport_introspection_cpp::Nested_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_msgs, msg, Nested)() {
  return &::test_msgs::msg::rosidl_typesupport_introspection_cpp::Nested_message_type_support_handle;
}
