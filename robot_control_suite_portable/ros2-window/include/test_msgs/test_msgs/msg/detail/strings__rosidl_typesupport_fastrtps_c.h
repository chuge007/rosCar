...
#ifndef TEST_MSGS__MSG__DETAIL__STRINGS__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
#define TEST_MSGS__MSG__DETAIL__STRINGS__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
...
bool cdr_serialize_test_msgs__msg__Strings(
  const test_msgs__msg__Strings * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_msgs
bool cdr_deserialize_test_msgs__msg__Strings(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_msgs
bool cdr_serialize_key_test_msgs__msg__Strings(
  const test_msgs__msg__Strings * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_msgs
size_t get_serialized_size_key_test_msgs__msg__Strings(
  const void * untyped_ros_message,
  size_t current_alignment);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_msgs
size_t max_serialized_size_key_test_msgs__msg__Strings(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
#endif  // TEST_MSGS__MSG__DETAIL__STRINGS__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
