...
class Init_Arrays_Event_response
{
public:
  explicit Init_Arrays_Event_response(::test_msgs::srv::Arrays_Event & msg)
  : msg_(msg)
  {}
  ::test_msgs::srv::Arrays_Event response(::test_msgs::srv::Arrays_Event::_response_type arg)
  {
...
private:
  ::test_msgs::srv::Arrays_Event msg_;
};

class Init_Arrays_Event_request
{
public:
  explicit Init_Arrays_Event_request(::test_msgs::srv::Arrays_Event & msg)
  : msg_(msg)
  {}
  Init_Arrays_Event_response request(::test_msgs::srv::Arrays_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Arrays_Event_response(msg_);
  }
...
class Init_Arrays_Event_info
{
public:
  Init_Arrays_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Arrays_Event_request info(::test_msgs::srv::Arrays_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Arrays_Event_request(msg_);
  }
...
template<>
inline
auto build<::test_msgs::srv::Arrays_Event>()
{
  return test_msgs::srv::builder::Init_Arrays_Event_info();
}
