...
[[deprecated("use test_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const test_msgs::srv::BasicTypes_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  test_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use test_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const test_msgs::srv::BasicTypes_Event & msg)
{
  return test_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<test_msgs::srv::BasicTypes_Event>()
{
  return "test_msgs::srv::BasicTypes_Event";
}

template<>
inline const char * name<test_msgs::srv::BasicTypes_Event>()
{
  return "test_msgs/srv/BasicTypes_Event";
}
