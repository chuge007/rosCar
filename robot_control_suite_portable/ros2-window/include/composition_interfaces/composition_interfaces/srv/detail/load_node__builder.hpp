...
class Init_LoadNode_Event_response
{
public:
  explicit Init_LoadNode_Event_response(::composition_interfaces::srv::LoadNode_Event & msg)
  : msg_(msg)
  {}
  ::composition_interfaces::srv::LoadNode_Event response(::composition_interfaces::srv::LoadNode_Event::_response_type arg)
  {
...
private:
  ::composition_interfaces::srv::LoadNode_Event msg_;
};

class Init_LoadNode_Event_request
{
public:
  explicit Init_LoadNode_Event_request(::composition_interfaces::srv::LoadNode_Event & msg)
  : msg_(msg)
  {}
  Init_LoadNode_Event_response request(::composition_interfaces::srv::LoadNode_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_LoadNode_Event_response(msg_);
  }
...
class Init_LoadNode_Event_info
{
public:
  Init_LoadNode_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_LoadNode_Event_request info(::composition_interfaces::srv::LoadNode_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_LoadNode_Event_request(msg_);
  }
...
template<>
inline
auto build<::composition_interfaces::srv::LoadNode_Event>()
{
  return composition_interfaces::srv::builder::Init_LoadNode_Event_info();
}
