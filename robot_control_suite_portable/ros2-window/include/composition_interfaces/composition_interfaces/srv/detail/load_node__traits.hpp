...
[[deprecated("use composition_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const composition_interfaces::srv::LoadNode_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  composition_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use composition_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const composition_interfaces::srv::LoadNode_Event & msg)
{
  return composition_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<composition_interfaces::srv::LoadNode_Event>()
{
  return "composition_interfaces::srv::LoadNode_Event";
}

template<>
inline const char * name<composition_interfaces::srv::LoadNode_Event>()
{
  return "composition_interfaces/srv/LoadNode_Event";
}
