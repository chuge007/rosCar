...
inline std::string to_yaml(const ListNodes_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use composition_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const composition_interfaces::srv::ListNodes_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  composition_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use composition_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const composition_interfaces::srv::ListNodes_Event & msg)
{
  return composition_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<composition_interfaces::srv::ListNodes_Event>()
{
  return "composition_interfaces::srv::ListNodes_Event";
}

template<>
inline const char * name<composition_interfaces::srv::ListNodes_Event>()
{
  return "composition_interfaces/srv/ListNodes_Event";
}

template<>
struct has_fixed_size<composition_interfaces::srv::ListNodes_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<composition_interfaces::srv::ListNodes_Event>
  : std::integral_constant<bool, has_bounded_size<composition_interfaces::srv::ListNodes_Request>::value && has_bounded_size<composition_interfaces::srv::ListNodes_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<composition_interfaces::srv::ListNodes_Event>
  : std::true_type {};
