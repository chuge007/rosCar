...
[[deprecated("use sensor_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const sensor_msgs::srv::SetCameraInfo_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  sensor_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use sensor_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const sensor_msgs::srv::SetCameraInfo_Event & msg)
{
  return sensor_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<sensor_msgs::srv::SetCameraInfo_Event>()
{
  return "sensor_msgs::srv::SetCameraInfo_Event";
}

template<>
inline const char * name<sensor_msgs::srv::SetCameraInfo_Event>()
{
  return "sensor_msgs/srv/SetCameraInfo_Event";
}
