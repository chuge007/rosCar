...
void sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_init_function(
...
void sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_fini_function(void * message_memory)
{
  sensor_msgs__msg__RelativeHumidity__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_member_array[3] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_members = {
...
static rosidl_message_type_support_t sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensor_msgs, msg, RelativeHumidity)() {
  sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_type_support_handle.typesupport_identifier) {
    sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &sensor_msgs__msg__RelativeHumidity__rosidl_typesupport_introspection_c__RelativeHumidity_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
