...
void fetch_function__MultiEchoLaserScan__ranges(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const sensor_msgs::msg::LaserEcho *>(
    get_const_function__MultiEchoLaserScan__ranges(untyped_member, index));
  auto & value = *reinterpret_cast<sensor_msgs::msg::LaserEcho *>(untyped_value);
  value = item;
}

void assign_function__MultiEchoLaserScan__ranges(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<sensor_msgs::msg::LaserEcho *>(
    get_function__MultiEchoLaserScan__ranges(untyped_member, index));
  const auto & value = *reinterpret_cast<const sensor_msgs::msg::LaserEcho *>(untyped_value);
  item = value;
}
...
void fetch_function__MultiEchoLaserScan__intensities(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const sensor_msgs::msg::LaserEcho *>(
    get_const_function__MultiEchoLaserScan__intensities(untyped_member, index));
  auto & value = *reinterpret_cast<sensor_msgs::msg::LaserEcho *>(untyped_value);
  value = item;
}

void assign_function__MultiEchoLaserScan__intensities(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<sensor_msgs::msg::LaserEcho *>(
    get_function__MultiEchoLaserScan__intensities(untyped_member, index));
  const auto & value = *reinterpret_cast<const sensor_msgs::msg::LaserEcho *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MultiEchoLaserScan_message_member_array[10] = {
  ...
  },
  {
    ...
    fetch_function__MultiEchoLaserScan__ranges,  // fetch(index, &value) function pointer
    assign_function__MultiEchoLaserScan__ranges,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__MultiEchoLaserScan__intensities,  // fetch(index, &value) function pointer
    assign_function__MultiEchoLaserScan__intensities,  // assign(index, value) function pointer
