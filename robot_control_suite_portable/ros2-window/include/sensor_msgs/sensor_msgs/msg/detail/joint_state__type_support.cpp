...
void fetch_function__JointState__name(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__JointState__name(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__JointState__name(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__JointState__name(untyped_member, index));
  const auto & value = *reinterpret_cast<const std::string *>(untyped_value);
  item = value;
}

void resize_function__JointState__name(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<std::string> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointState_message_member_array[5] = {
  {
    ...
    offsetof(sensor_msgs::msg::JointState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::JointState, name),  // bytes offset in struct
    nullptr,  // default value
    ...
    fetch_function__JointState__name,  // fetch(index, &value) function pointer
    assign_function__JointState__name,  // assign(index, value) function pointer
    resize_function__JointState__name  // resize(index) function pointer
  },
  {
    "position",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::JointState, position),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::JointState, velocity),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::JointState, effort),  // bytes offset in struct
    nullptr,  // default value
...
get_message_type_support_handle<sensor_msgs::msg::JointState>()
{
  return &::sensor_msgs::msg::rosidl_typesupport_introspection_cpp::JointState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_msgs, msg, JointState)() {
  return &::sensor_msgs::msg::rosidl_typesupport_introspection_cpp::JointState_message_type_support_handle;
}
