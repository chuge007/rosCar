...
void fetch_function__ChannelFloat32__values(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__ChannelFloat32__values(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__ChannelFloat32__values(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__ChannelFloat32__values(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ChannelFloat32_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__ChannelFloat32__values,  // fetch(index, &value) function pointer
    assign_function__ChannelFloat32__values,  // assign(index, value) function pointer
