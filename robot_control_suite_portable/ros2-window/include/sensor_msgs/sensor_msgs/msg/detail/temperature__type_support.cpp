...
{
  new (message_memory) sensor_msgs::msg::Temperature(_init);
}

void Temperature_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sensor_msgs::msg::Temperature *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Temperature_message_member_array[3] = {
  {
    ...
    offsetof(sensor_msgs::msg::Temperature, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::Temperature, temperature),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::Temperature, variance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Temperature_message_members = {
  ...
  3,  // number of fields
  sizeof(sensor_msgs::msg::Temperature),
...
get_message_type_support_handle<sensor_msgs::msg::Temperature>()
{
  return &::sensor_msgs::msg::rosidl_typesupport_introspection_cpp::Temperature_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_msgs, msg, Temperature)() {
  return &::sensor_msgs::msg::rosidl_typesupport_introspection_cpp::Temperature_message_type_support_handle;
}
