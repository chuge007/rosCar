...
{
  new (message_memory) sensor_msgs::msg::LaserScan(_init);
}

void LaserScan_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sensor_msgs::msg::LaserScan *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LaserScan_message_member_array[10] = {
  {
    "header",  // name
    ...
    offsetof(sensor_msgs::msg::LaserScan, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::LaserScan, angle_min),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::LaserScan, angle_max),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::LaserScan, angle_increment),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::LaserScan, time_increment),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::LaserScan, scan_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::LaserScan, range_min),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::LaserScan, range_max),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::LaserScan, ranges),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_msgs::msg::LaserScan, intensities),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LaserScan_message_members = {
  ...
  10,  // number of fields
  sizeof(sensor_msgs::msg::LaserScan),
...
{
  return &::sensor_msgs::msg::rosidl_typesupport_introspection_cpp::LaserScan_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_msgs, msg, LaserScan)() {
  return &::sensor_msgs::msg::rosidl_typesupport_introspection_cpp::LaserScan_message_type_support_handle;
}
