...
{
  const auto & item = *reinterpret_cast<const actionlib_msgs::msg::GoalStatus *>(
    get_const_function__GoalStatusArray__status_list(untyped_member, index));
  auto & value = *reinterpret_cast<actionlib_msgs::msg::GoalStatus *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<actionlib_msgs::msg::GoalStatus *>(
    get_function__GoalStatusArray__status_list(untyped_member, index));
  const auto & value = *reinterpret_cast<const actionlib_msgs::msg::GoalStatus *>(untyped_value);
  item = value;
}
