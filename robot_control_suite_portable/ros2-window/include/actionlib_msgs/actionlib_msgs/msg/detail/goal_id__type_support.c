...
void actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_init_function(
...
void actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_fini_function(void * message_memory)
{
  actionlib_msgs__msg__GoalID__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_message_member_array[2] = {
  {
    "stamp",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_message_members = {
...
static rosidl_message_type_support_t actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, actionlib_msgs, msg, GoalID)() {
  actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, builtin_interfaces, msg, Time)();
  if (!actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_message_type_support_handle.typesupport_identifier) {
    actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &actionlib_msgs__msg__GoalID__rosidl_typesupport_introspection_c__GoalID_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
