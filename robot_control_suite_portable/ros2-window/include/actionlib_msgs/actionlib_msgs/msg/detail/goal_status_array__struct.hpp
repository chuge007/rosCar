...
// IWYU pragma: private, include "actionlib_msgs/msg/goal_status_array.hpp"
...
struct GoalStatusArray_
{
  ...
  using _status_list_type =
    std::vector<actionlib_msgs::msg::GoalStatus_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<actionlib_msgs::msg::GoalStatus_<ContainerAllocator>>>;
  ...
  Type & set__status_list(
    const std::vector<actionlib_msgs::msg::GoalStatus_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<actionlib_msgs::msg::GoalStatus_<ContainerAllocator>>> & _arg)
  {
