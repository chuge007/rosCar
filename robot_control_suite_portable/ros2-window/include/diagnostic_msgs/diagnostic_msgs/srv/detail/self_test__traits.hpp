...
[[deprecated("use diagnostic_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const diagnostic_msgs::srv::SelfTest_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  diagnostic_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use diagnostic_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const diagnostic_msgs::srv::SelfTest_Event & msg)
{
  return diagnostic_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<diagnostic_msgs::srv::SelfTest_Event>()
{
  return "diagnostic_msgs::srv::SelfTest_Event";
}

template<>
inline const char * name<diagnostic_msgs::srv::SelfTest_Event>()
{
  return "diagnostic_msgs/srv/SelfTest_Event";
}
