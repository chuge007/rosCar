...
void diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_init_function(
...
void diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_fini_function(void * message_memory)
{
  diagnostic_msgs__msg__KeyValue__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_message_member_array[2] = {
  {
    "key",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_message_members = {
...
static rosidl_message_type_support_t diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, diagnostic_msgs, msg, KeyValue)() {
  if (!diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_message_type_support_handle.typesupport_identifier) {
    diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &diagnostic_msgs__msg__KeyValue__rosidl_typesupport_introspection_c__KeyValue_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
