...
[[deprecated("use std_srvs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const std_srvs::srv::Trigger_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  std_srvs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use std_srvs::srv::to_yaml() instead")]]
inline std::string to_yaml(const std_srvs::srv::Trigger_Event & msg)
{
  return std_srvs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<std_srvs::srv::Trigger_Event>()
{
  return "std_srvs::srv::Trigger_Event";
}

template<>
inline const char * name<std_srvs::srv::Trigger_Event>()
{
  return "std_srvs/srv/Trigger_Event";
}

template<>
struct has_fixed_size<std_srvs::srv::Trigger_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<std_srvs::srv::Trigger_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<std_srvs::srv::Trigger_Request>::value && has_bounded_size<std_srvs::srv::Trigger_Response>::value> {};

template<>
struct is_message<std_srvs::srv::Trigger_Event>
  : std::true_type {};
