...
#ifndef _WIN32
# define DEPRECATED__std_srvs__srv__SetBool_Event __attribute__((deprecated))
#else
# define DEPRECATED__std_srvs__srv__SetBool_Event __declspec(deprecated)
#endif
...
struct SetBool_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<std_srvs::srv::SetBool_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std_srvs::srv::SetBool_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<std_srvs::srv::SetBool_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std_srvs::srv::SetBool_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<std_srvs::srv::SetBool_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std_srvs::srv::SetBool_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<std_srvs::srv::SetBool_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std_srvs::srv::SetBool_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    std_srvs::srv::SetBool_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const std_srvs::srv::SetBool_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<std_srvs::srv::SetBool_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<std_srvs::srv::SetBool_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      std_srvs::srv::SetBool_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<std_srvs::srv::SetBool_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      std_srvs::srv::SetBool_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<std_srvs::srv::SetBool_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<std_srvs::srv::SetBool_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<std_srvs::srv::SetBool_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__std_srvs__srv__SetBool_Event
    std::shared_ptr<std_srvs::srv::SetBool_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__std_srvs__srv__SetBool_Event
    std::shared_ptr<std_srvs::srv::SetBool_Event_<ContainerAllocator> const>
...
// alias to use template instance with default allocator
using SetBool_Event =
  std_srvs::srv::SetBool_Event_<std::allocator<void>>;
