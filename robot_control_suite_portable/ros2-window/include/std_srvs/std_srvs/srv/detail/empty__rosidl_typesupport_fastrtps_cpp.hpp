...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_std_srvs
cdr_serialize(
  const std_srvs::srv::Empty_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  std_srvs::srv::Empty_Event & ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_std_srvs
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, std_srvs, srv, Empty_Event)();
