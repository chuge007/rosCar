  ...
  std_srvs__srv__SetBool_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    std_srvs__srv__SetBool_Request * data =
      (std_srvs__srv__SetBool_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!std_srvs__srv__SetBool_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          std_srvs__srv__SetBool_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  std_srvs__srv__SetBool_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    std_srvs__srv__SetBool_Response * data =
      (std_srvs__srv__SetBool_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!std_srvs__srv__SetBool_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          std_srvs__srv__SetBool_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
bool
std_srvs__srv__SetBool_Event__init(std_srvs__srv__SetBool_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    std_srvs__srv__SetBool_Event__fini(msg);
    return false;
  }
  // request
  if (!std_srvs__srv__SetBool_Request__Sequence__init(&msg->request, 0)) {
    std_srvs__srv__SetBool_Event__fini(msg);
    return false;
  }
  // response
  if (!std_srvs__srv__SetBool_Response__Sequence__init(&msg->response, 0)) {
    std_srvs__srv__SetBool_Event__fini(msg);
    return false;
  }
  return true;
...
void
std_srvs__srv__SetBool_Event__fini(std_srvs__srv__SetBool_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  std_srvs__srv__SetBool_Request__Sequence__fini(&msg->request);
  // response
  std_srvs__srv__SetBool_Response__Sequence__fini(&msg->response);
}

bool
std_srvs__srv__SetBool_Event__are_equal(const std_srvs__srv__SetBool_Event * lhs, const std_srvs__srv__SetBool_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!std_srvs__srv__SetBool_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!std_srvs__srv__SetBool_Response__Sequence__are_equal(
...
bool
std_srvs__srv__SetBool_Event__copy(
  const std_srvs__srv__SetBool_Event * input,
  std_srvs__srv__SetBool_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!std_srvs__srv__SetBool_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!std_srvs__srv__SetBool_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  std_srvs__srv__SetBool_Event * msg = (std_srvs__srv__SetBool_Event *)allocator.allocate(sizeof(std_srvs__srv__SetBool_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(std_srvs__srv__SetBool_Event));
  bool success = std_srvs__srv__SetBool_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
std_srvs__srv__SetBool_Event__destroy(std_srvs__srv__SetBool_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    std_srvs__srv__SetBool_Event__fini(msg);
...
bool
std_srvs__srv__SetBool_Event__Sequence__init(std_srvs__srv__SetBool_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  std_srvs__srv__SetBool_Event * data = NULL;

  if (size) {
    data = (std_srvs__srv__SetBool_Event *)allocator.zero_allocate(size, sizeof(std_srvs__srv__SetBool_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = std_srvs__srv__SetBool_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        std_srvs__srv__SetBool_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
std_srvs__srv__SetBool_Event__Sequence__fini(std_srvs__srv__SetBool_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      std_srvs__srv__SetBool_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
std_srvs__srv__SetBool_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  std_srvs__srv__SetBool_Event__Sequence * array = (std_srvs__srv__SetBool_Event__Sequence *)allocator.allocate(sizeof(std_srvs__srv__SetBool_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = std_srvs__srv__SetBool_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
std_srvs__srv__SetBool_Event__Sequence__destroy(std_srvs__srv__SetBool_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    std_srvs__srv__SetBool_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
std_srvs__srv__SetBool_Event__Sequence__are_equal(const std_srvs__srv__SetBool_Event__Sequence * lhs, const std_srvs__srv__SetBool_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!std_srvs__srv__SetBool_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
std_srvs__srv__SetBool_Event__Sequence__copy(
  const std_srvs__srv__SetBool_Event__Sequence * input,
  std_srvs__srv__SetBool_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(std_srvs__srv__SetBool_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    std_srvs__srv__SetBool_Event * data =
      (std_srvs__srv__SetBool_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!std_srvs__srv__SetBool_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          std_srvs__srv__SetBool_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!std_srvs__srv__SetBool_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
