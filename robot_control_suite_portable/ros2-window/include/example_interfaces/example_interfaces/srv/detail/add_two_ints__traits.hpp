...
[[deprecated("use example_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const example_interfaces::srv::AddTwoInts_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  example_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use example_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const example_interfaces::srv::AddTwoInts_Event & msg)
{
  return example_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<example_interfaces::srv::AddTwoInts_Event>()
{
  return "example_interfaces::srv::AddTwoInts_Event";
}

template<>
inline const char * name<example_interfaces::srv::AddTwoInts_Event>()
{
  return "example_interfaces/srv/AddTwoInts_Event";
}

template<>
struct has_fixed_size<example_interfaces::srv::AddTwoInts_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<example_interfaces::srv::AddTwoInts_Event>
  : std::integral_constant<bool, has_bounded_size<example_interfaces::srv::AddTwoInts_Request>::value && has_bounded_size<example_interfaces::srv::AddTwoInts_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<example_interfaces::srv::AddTwoInts_Event>
  : std::true_type {};
