...
[[deprecated("use example_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const example_interfaces::srv::Trigger_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  example_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use example_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const example_interfaces::srv::Trigger_Event & msg)
{
  return example_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<example_interfaces::srv::Trigger_Event>()
{
  return "example_interfaces::srv::Trigger_Event";
}

template<>
inline const char * name<example_interfaces::srv::Trigger_Event>()
{
  return "example_interfaces/srv/Trigger_Event";
}
