...
inline void to_yaml(
  const example_interfaces::msg::Float32MultiArray & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const example_interfaces::msg::Float32MultiArray & msg)
{
...
template<>
inline const char * name<example_interfaces::msg::Float32MultiArray>()
{
  return "example_interfaces/msg/Float32MultiArray";
}
