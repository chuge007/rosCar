...
{
  new (message_memory) example_interfaces::msg::Float32MultiArray(_init);
}

void Float32MultiArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<example_interfaces::msg::Float32MultiArray *>(message_memory);
