...
{
  const auto & item = *reinterpret_cast<const example_interfaces::msg::MultiArrayDimension *>(
    get_const_function__MultiArrayLayout__dim(untyped_member, index));
  auto & value = *reinterpret_cast<example_interfaces::msg::MultiArrayDimension *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<example_interfaces::msg::MultiArrayDimension *>(
    get_function__MultiArrayLayout__dim(untyped_member, index));
  const auto & value = *reinterpret_cast<const example_interfaces::msg::MultiArrayDimension *>(untyped_value);
  item = value;
}
