...
#ifndef EXAMPLE_INTERFACES__MSG__DETAIL__INT32_MULTI_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
#define EXAMPLE_INTERFACES__MSG__DETAIL__INT32_MULTI_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
...
bool cdr_serialize_example_interfaces__msg__Int32MultiArray(
  const example_interfaces__msg__Int32MultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_example_interfaces
bool cdr_deserialize_example_interfaces__msg__Int32MultiArray(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_example_interfaces
bool cdr_serialize_key_example_interfaces__msg__Int32MultiArray(
  const example_interfaces__msg__Int32MultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_example_interfaces
size_t get_serialized_size_key_example_interfaces__msg__Int32MultiArray(
  const void * untyped_ros_message,
  size_t current_alignment);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_example_interfaces
size_t max_serialized_size_key_example_interfaces__msg__Int32MultiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
#endif  // EXAMPLE_INTERFACES__MSG__DETAIL__INT32_MULTI_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
