...
inline void to_yaml(
  const example_interfaces::msg::UInt16MultiArray & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const example_interfaces::msg::UInt16MultiArray & msg)
{
...
template<>
inline const char * name<example_interfaces::msg::UInt16MultiArray>()
{
  return "example_interfaces/msg/UInt16MultiArray";
}
