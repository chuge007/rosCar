...
{
  new (message_memory) example_interfaces::msg::Int16MultiArray(_init);
}

void Int16MultiArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<example_interfaces::msg::Int16MultiArray *>(message_memory);
...
void fetch_function__Int16MultiArray__data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__Int16MultiArray__data(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__Int16MultiArray__data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__Int16MultiArray__data(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Int16MultiArray_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__Int16MultiArray__data,  // fetch(index, &value) function pointer
    assign_function__Int16MultiArray__data,  // assign(index, value) function pointer
