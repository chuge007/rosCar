...
inline std::string to_yaml(const Int16 & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const example_interfaces::msg::Int16 & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const example_interfaces::msg::Int16 & msg)
{
...
template<>
inline const char * name<example_interfaces::msg::Int16>()
{
  return "example_interfaces/msg/Int16";
}
