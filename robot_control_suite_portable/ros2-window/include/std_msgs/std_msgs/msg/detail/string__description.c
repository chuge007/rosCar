...
static char std_msgs__msg__String__FIELD_NAME__data[] = "data";

static rosidl_runtime_c__type_description__Field std_msgs__msg__String__FIELDS[] = {
  {
    {std_msgs__msg__String__FIELD_NAME__data, 4, 4},
    {
