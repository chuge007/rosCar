...
{
  new (message_memory) std_msgs::msg::Empty(_init);
}

void Empty_fini_function(void * message_memory)
{
  auto typed_message = static_cast<std_msgs::msg::Empty *>(message_memory);
  typed_message->~Empty();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Empty_message_member_array[1] = {
  {
    ...
    offsetof(std_msgs::msg::Empty, structure_needs_at_least_one_member),  // bytes offset in struct
