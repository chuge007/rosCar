...
#ifndef STD_MSGS__MSG__DETAIL__FLOAT64_MULTI_ARRAY__TRAITS_HPP_
...
inline std::string to_yaml(const std_msgs::msg::Float64MultiArray & msg)
{
...
template<>
inline const char * name<std_msgs::msg::Float64MultiArray>()
{
  return "std_msgs/msg/Float64MultiArray";
}
...
template<>
struct is_message<std_msgs::msg::Float64MultiArray>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // STD_MSGS__MSG__DETAIL__FLOAT64_MULTI_ARRAY__TRAITS_HPP_
