...
static char std_msgs__msg__MultiArrayDimension__FIELD_NAME__label[] = "label";
static char std_msgs__msg__MultiArrayDimension__FIELD_NAME__size[] = "size";
static char std_msgs__msg__MultiArrayDimension__FIELD_NAME__stride[] = "stride";

static rosidl_runtime_c__type_description__Field std_msgs__msg__MultiArrayDimension__FIELDS[] = {
  {
    {std_msgs__msg__MultiArrayDimension__FIELD_NAME__label, 5, 5},
    {
  ...
  {
    {std_msgs__msg__MultiArrayDimension__FIELD_NAME__size, 4, 4},
    {
  ...
  {
    {std_msgs__msg__MultiArrayDimension__FIELD_NAME__stride, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT32,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {std_msgs__msg__MultiArrayDimension__FIELDS, 3, 3},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *std_msgs__msg__MultiArrayDimension__get_individual_type_description_source(NULL),
    constructed = true;
  }
