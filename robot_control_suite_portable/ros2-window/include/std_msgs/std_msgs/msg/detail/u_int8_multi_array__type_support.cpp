...
{
  new (message_memory) std_msgs::msg::UInt8MultiArray(_init);
}

void UInt8MultiArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<std_msgs::msg::UInt8MultiArray *>(message_memory);
...
void fetch_function__UInt8MultiArray__data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint8_t *>(
    get_const_function__UInt8MultiArray__data(untyped_member, index));
  auto & value = *reinterpret_cast<uint8_t *>(untyped_value);
  value = item;
}

void assign_function__UInt8MultiArray__data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint8_t *>(
    get_function__UInt8MultiArray__data(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UInt8MultiArray_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__UInt8MultiArray__data,  // fetch(index, &value) function pointer
    assign_function__UInt8MultiArray__data,  // assign(index, value) function pointer
