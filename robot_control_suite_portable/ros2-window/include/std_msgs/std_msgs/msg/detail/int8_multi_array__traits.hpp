...
#ifndef STD_MSGS__MSG__DETAIL__INT8_MULTI_ARRAY__TRAITS_HPP_
#define STD_MSGS__MSG__DETAIL__INT8_MULTI_ARRAY__TRAITS_HPP_
...
inline std::string to_yaml(const Int8MultiArray & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const std_msgs::msg::Int8MultiArray & msg)
{
  return std_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<std_msgs::msg::Int8MultiArray>()
{
  return "std_msgs::msg::Int8MultiArray";
}

template<>
inline const char * name<std_msgs::msg::Int8MultiArray>()
{
  return "std_msgs/msg/Int8MultiArray";
}
...
#endif  // STD_MSGS__MSG__DETAIL__INT8_MULTI_ARRAY__TRAITS_HPP_
