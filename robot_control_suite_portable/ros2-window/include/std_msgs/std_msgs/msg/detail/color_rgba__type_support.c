...
void std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  std_msgs__msg__ColorRGBA__init(message_memory);
}

void std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_fini_function(void * message_memory)
{
  std_msgs__msg__ColorRGBA__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_message_member_array[4] = {
  {
    "r",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_message_members = {
...
static rosidl_message_type_support_t std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, ColorRGBA)() {
  if (!std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_message_type_support_handle.typesupport_identifier) {
    std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &std_msgs__msg__ColorRGBA__rosidl_typesupport_introspection_c__ColorRGBA_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
