...
#ifndef STD_MSGS__MSG__DETAIL__INT8__TRAITS_HPP_
#define STD_MSGS__MSG__DETAIL__INT8__TRAITS_HPP_
...
inline std::string to_yaml(const Int8 & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const std_msgs::msg::Int8 & msg)
{
...
template<>
inline const char * name<std_msgs::msg::Int8>()
{
  return "std_msgs/msg/Int8";
}
...
template<>
struct is_message<std_msgs::msg::Int8>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // STD_MSGS__MSG__DETAIL__INT8__TRAITS_HPP_
