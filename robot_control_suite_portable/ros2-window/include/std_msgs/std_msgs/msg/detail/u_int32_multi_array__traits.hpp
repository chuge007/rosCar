...
#ifndef STD_MSGS__MSG__DETAIL__U_INT32_MULTI_ARRAY__TRAITS_HPP_
#define STD_MSGS__MSG__DETAIL__U_INT32_MULTI_ARRAY__TRAITS_HPP_
...
inline void to_yaml(
  const std_msgs::msg::UInt32MultiArray & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const std_msgs::msg::UInt32MultiArray & msg)
{
  return std_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<std_msgs::msg::UInt32MultiArray>()
{
  return "std_msgs::msg::UInt32MultiArray";
}

template<>
inline const char * name<std_msgs::msg::UInt32MultiArray>()
{
  return "std_msgs/msg/UInt32MultiArray";
}
...
template<>
struct has_bounded_size<std_msgs::msg::UInt32MultiArray>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<std_msgs::msg::UInt32MultiArray>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // STD_MSGS__MSG__DETAIL__U_INT32_MULTI_ARRAY__TRAITS_HPP_
