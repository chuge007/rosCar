...
static rosidl_typesupport_introspection_c__MessageMember std_msgs__msg__String__rosidl_typesupport_introspection_c__String_message_member_array[1] = {
  {
    "data",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers std_msgs__msg__String__rosidl_typesupport_introspection_c__String_message_members = {
  "std_msgs__msg",  // message namespace
  "String",  // message name
  1,  // number of fields
  sizeof(std_msgs__msg__String),
  false,  // has_any_key_member_
  std_msgs__msg__String__rosidl_typesupport_introspection_c__String_message_member_array,  // message members
  std_msgs__msg__String__rosidl_typesupport_introspection_c__String_init_function,  // function to initialize message memory (memory has to be allocated)
  std_msgs__msg__String__rosidl_typesupport_introspection_c__String_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t std_msgs__msg__String__rosidl_typesupport_introspection_c__String_message_type_support_handle = {
  0,
  &std_msgs__msg__String__rosidl_typesupport_introspection_c__String_message_members,
