...
{
  const auto & item = *reinterpret_cast<const shape_msgs::msg::MeshTriangle *>(
    get_const_function__Mesh__triangles(untyped_member, index));
  auto & value = *reinterpret_cast<shape_msgs::msg::MeshTriangle *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<shape_msgs::msg::MeshTriangle *>(
    get_function__Mesh__triangles(untyped_member, index));
  const auto & value = *reinterpret_cast<const shape_msgs::msg::MeshTriangle *>(untyped_value);
  item = value;
}
