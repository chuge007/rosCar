...
void fetch_function__MeshTriangle__vertex_indices(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint32_t *>(
    get_const_function__MeshTriangle__vertex_indices(untyped_member, index));
  auto & value = *reinterpret_cast<uint32_t *>(untyped_value);
  value = item;
}

void assign_function__MeshTriangle__vertex_indices(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint32_t *>(
    get_function__MeshTriangle__vertex_indices(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MeshTriangle_message_member_array[1] = {
  {
    ...
    fetch_function__MeshTriangle__vertex_indices,  // fetch(index, &value) function pointer
    assign_function__MeshTriangle__vertex_indices,  // assign(index, value) function pointer
