...
#ifndef ROSBAG2_TEST_MSGDEFS__MSG__DETAIL__BASIC_IDL__TYPE_SUPPORT_H_
#define ROSBAG2_TEST_MSGDEFS__MSG__DETAIL__BASIC_IDL__TYPE_SUPPORT_H_
...
#endif  // ROSBAG2_TEST_MSGDEFS__MSG__DETAIL__BASIC_IDL__TYPE_SUPPORT_H_
