...
inline void to_yaml(
  const rosbag2_test_msgdefs::msg::ComplexIdl & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosbag2_test_msgdefs::msg::ComplexIdl & msg)
{
  return rosbag2_test_msgdefs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rosbag2_test_msgdefs::msg::ComplexIdl>()
{
  return "rosbag2_test_msgdefs::msg::ComplexIdl";
}

template<>
inline const char * name<rosbag2_test_msgdefs::msg::ComplexIdl>()
{
  return "rosbag2_test_msgdefs/msg/ComplexIdl";
}
