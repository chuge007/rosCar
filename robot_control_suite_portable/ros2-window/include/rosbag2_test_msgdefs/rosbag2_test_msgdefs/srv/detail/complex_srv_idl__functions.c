...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__init(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request * msg)
{
  ...
  // req
  if (!rosbag2_test_msgdefs__msg__BasicIdl__init(&msg->req)) {
    rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__fini(msg);
    return false;
  }
  return true;
}
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__fini(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request * msg)
{
  ...
  // req
  rosbag2_test_msgdefs__msg__BasicIdl__fini(&msg->req);
}
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__create(void)
{
  ...
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request * msg = (rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request *)allocator.allocate(sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request));
  bool success = rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__init(msg);
  if (!success) {
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence__init(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request * data = NULL;

  if (size) {
    data = (rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request *)allocator.zero_allocate(size, sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__fini(&data[i - 1]);
      }
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence__fini(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence * array = (rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence *)allocator.allocate(sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence__init(array, size);
  if (!success) {
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence__destroy(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence__are_equal(const rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence * lhs, const rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request * data =
      (rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__copy(
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__init(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response * msg)
{
  ...
  // resp
  if (!rosbag2_test_msgdefs__msg__BasicIdl__init(&msg->resp)) {
    rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__fini(msg);
    return false;
  }
  return true;
}
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__fini(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response * msg)
{
  ...
  // resp
  rosbag2_test_msgdefs__msg__BasicIdl__fini(&msg->resp);
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response * msg = (rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response *)allocator.allocate(sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response));
  bool success = rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence__init(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response * data = NULL;

  if (size) {
    data = (rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response *)allocator.zero_allocate(size, sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence__fini(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence * array = (rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence *)allocator.allocate(sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence__destroy(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence__are_equal(const rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence * lhs, const rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response * data =
      (rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__init(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__fini(msg);
    return false;
  }
  // request
  if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence__init(&msg->request, 0)) {
    rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__fini(msg);
    return false;
  }
  // response
  if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence__init(&msg->response, 0)) {
    rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__fini(msg);
    return false;
  }
  return true;
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__fini(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event * msg)
{
  ...
  // request
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence__fini(&msg->request);
  // response
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence__fini(&msg->response);
}
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__are_equal(const rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event * lhs, const rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event * rhs)
{
  ...
  // request
  if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence__are_equal(
  ...
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event * output)
{
  ...
  // request
  if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event * msg = (rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event *)allocator.allocate(sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event));
  bool success = rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence__init(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event * data = NULL;

  if (size) {
    data = (rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event *)allocator.zero_allocate(size, sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence__fini(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence * array = (rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence *)allocator.allocate(sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence__destroy(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence__are_equal(const rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence * lhs, const rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event * data =
      (rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbag2_test_msgdefs__srv__ComplexSrvIdl_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
