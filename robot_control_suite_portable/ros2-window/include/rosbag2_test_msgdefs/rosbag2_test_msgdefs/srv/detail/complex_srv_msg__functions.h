...
#ifndef ROSBAG2_TEST_MSGDEFS__SRV__DETAIL__COMPLEX_SRV_MSG__FUNCTIONS_H_
#define ROSBAG2_TEST_MSGDEFS__SRV__DETAIL__COMPLEX_SRV_MSG__FUNCTIONS_H_
...
/// Initialize srv/ComplexSrvMsg message.
/**
 ...
 * )) before or use
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Request__create()
...
/// Finalize srv/ComplexSrvMsg message.
/**
...
/// Create srv/ComplexSrvMsg message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Request__init().
...
/// Destroy srv/ComplexSrvMsg message.
/**
 * It calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Request__fini()
...
/// Check for srv/ComplexSrvMsg message equality.
/**
...
/// Copy a srv/ComplexSrvMsg message.
/**
...
/// Initialize array of srv/ComplexSrvMsg messages.
/**
...
/// Finalize array of srv/ComplexSrvMsg messages.
/**
 * It calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Request__fini()
...
/// Create array of srv/ComplexSrvMsg messages.
/**
 * It allocates the memory for the array and calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ComplexSrvMsg messages.
/**
 * It calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ComplexSrvMsg message array equality.
/**
...
/// Copy an array of srv/ComplexSrvMsg messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbag2_test_msgdefs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbag2_test_msgdefs
...
/**
 * It calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbag2_test_msgdefs
...
/**
 * It allocates the memory for the array and calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbag2_test_msgdefs
...
/**
 * It calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbag2_test_msgdefs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbag2_test_msgdefs
...
/**
 * It calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbag2_test_msgdefs
...
/**
 * It allocates the memory for the array and calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbag2_test_msgdefs
...
/**
 * It calls
 * rosbag2_test_msgdefs__srv__ComplexSrvMsg_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROSBAG2_TEST_MSGDEFS__SRV__DETAIL__COMPLEX_SRV_MSG__FUNCTIONS_H_
