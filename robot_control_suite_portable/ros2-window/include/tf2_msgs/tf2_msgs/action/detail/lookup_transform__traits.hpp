...
[[deprecated("use tf2_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const tf2_msgs::action::LookupTransform_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  tf2_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use tf2_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const tf2_msgs::action::LookupTransform_SendGoal_Event & msg)
{
  return tf2_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<tf2_msgs::action::LookupTransform_SendGoal_Event>()
{
  return "tf2_msgs::action::LookupTransform_SendGoal_Event";
}

template<>
inline const char * name<tf2_msgs::action::LookupTransform_SendGoal_Event>()
{
  return "tf2_msgs/action/LookupTransform_SendGoal_Event";
}
...
[[deprecated("use tf2_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const tf2_msgs::action::LookupTransform_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  tf2_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use tf2_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const tf2_msgs::action::LookupTransform_GetResult_Event & msg)
{
  return tf2_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<tf2_msgs::action::LookupTransform_GetResult_Event>()
{
  return "tf2_msgs::action::LookupTransform_GetResult_Event";
}

template<>
inline const char * name<tf2_msgs::action::LookupTransform_GetResult_Event>()
{
  return "tf2_msgs/action/LookupTransform_GetResult_Event";
}
