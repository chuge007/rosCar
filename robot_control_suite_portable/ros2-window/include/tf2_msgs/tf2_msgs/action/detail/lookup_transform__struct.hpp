...
#ifndef _WIN32
# define DEPRECATED__tf2_msgs__action__LookupTransform_SendGoal_Event __attribute__((deprecated))
#else
# define DEPRECATED__tf2_msgs__action__LookupTransform_SendGoal_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct LookupTransform_SendGoal_Event_
{
  using Type = LookupTransform_SendGoal_Event_<ContainerAllocator>;

  explicit LookupTransform_SendGoal_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit LookupTransform_SendGoal_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<tf2_msgs::action::LookupTransform_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tf2_msgs::action::LookupTransform_SendGoal_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<tf2_msgs::action::LookupTransform_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tf2_msgs::action::LookupTransform_SendGoal_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<tf2_msgs::action::LookupTransform_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tf2_msgs::action::LookupTransform_SendGoal_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<tf2_msgs::action::LookupTransform_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tf2_msgs::action::LookupTransform_SendGoal_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    tf2_msgs::action::LookupTransform_SendGoal_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const tf2_msgs::action::LookupTransform_SendGoal_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<tf2_msgs::action::LookupTransform_SendGoal_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<tf2_msgs::action::LookupTransform_SendGoal_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      tf2_msgs::action::LookupTransform_SendGoal_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<tf2_msgs::action::LookupTransform_SendGoal_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      tf2_msgs::action::LookupTransform_SendGoal_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<tf2_msgs::action::LookupTransform_SendGoal_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<tf2_msgs::action::LookupTransform_SendGoal_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<tf2_msgs::action::LookupTransform_SendGoal_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__tf2_msgs__action__LookupTransform_SendGoal_Event
    std::shared_ptr<tf2_msgs::action::LookupTransform_SendGoal_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__tf2_msgs__action__LookupTransform_SendGoal_Event
    std::shared_ptr<tf2_msgs::action::LookupTransform_SendGoal_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const LookupTransform_SendGoal_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using LookupTransform_SendGoal_Event =
  tf2_msgs::action::LookupTransform_SendGoal_Event_<std::allocator<void>>;
...
struct LookupTransform_SendGoal
{
  ...
  using Event = tf2_msgs::action::LookupTransform_SendGoal_Event;
};
...
#ifndef _WIN32
# define DEPRECATED__tf2_msgs__action__LookupTransform_GetResult_Event __attribute__((deprecated))
#else
# define DEPRECATED__tf2_msgs__action__LookupTransform_GetResult_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct LookupTransform_GetResult_Event_
{
  using Type = LookupTransform_GetResult_Event_<ContainerAllocator>;

  explicit LookupTransform_GetResult_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit LookupTransform_GetResult_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<tf2_msgs::action::LookupTransform_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tf2_msgs::action::LookupTransform_GetResult_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<tf2_msgs::action::LookupTransform_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tf2_msgs::action::LookupTransform_GetResult_Response_<ContainerAllocator>>>;
  _response_type response;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<tf2_msgs::action::LookupTransform_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tf2_msgs::action::LookupTransform_GetResult_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<tf2_msgs::action::LookupTransform_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tf2_msgs::action::LookupTransform_GetResult_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    tf2_msgs::action::LookupTransform_GetResult_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const tf2_msgs::action::LookupTransform_GetResult_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<tf2_msgs::action::LookupTransform_GetResult_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<tf2_msgs::action::LookupTransform_GetResult_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      tf2_msgs::action::LookupTransform_GetResult_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<tf2_msgs::action::LookupTransform_GetResult_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      tf2_msgs::action::LookupTransform_GetResult_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<tf2_msgs::action::LookupTransform_GetResult_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<tf2_msgs::action::LookupTransform_GetResult_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<tf2_msgs::action::LookupTransform_GetResult_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__tf2_msgs__action__LookupTransform_GetResult_Event
    std::shared_ptr<tf2_msgs::action::LookupTransform_GetResult_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__tf2_msgs__action__LookupTransform_GetResult_Event
    std::shared_ptr<tf2_msgs::action::LookupTransform_GetResult_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const LookupTransform_GetResult_Event_ & other) const
  {
    if (this->info != other.info) {
      return false;
    }
...
// alias to use template instance with default allocator
using LookupTransform_GetResult_Event =
  tf2_msgs::action::LookupTransform_GetResult_Event_<std::allocator<void>>;
...
struct LookupTransform_GetResult
{
  ...
  using Event = tf2_msgs::action::LookupTransform_GetResult_Event;
};
