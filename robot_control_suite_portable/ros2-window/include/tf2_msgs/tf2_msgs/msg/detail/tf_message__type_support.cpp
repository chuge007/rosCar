...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TFMessage_message_member_array[1] = {
  {
    ...
    fetch_function__TFMessage__transforms,  // fetch(index, &value) function pointer
    assign_function__TFMessage__transforms,  // assign(index, value) function pointer
