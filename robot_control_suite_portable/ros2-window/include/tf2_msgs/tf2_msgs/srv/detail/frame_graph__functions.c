...
bool
tf2_msgs__srv__FrameGraph_Event__init(tf2_msgs__srv__FrameGraph_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    tf2_msgs__srv__FrameGraph_Event__fini(msg);
    return false;
  }
  // request
  if (!tf2_msgs__srv__FrameGraph_Request__Sequence__init(&msg->request, 0)) {
    tf2_msgs__srv__FrameGraph_Event__fini(msg);
    return false;
  }
  // response
  if (!tf2_msgs__srv__FrameGraph_Response__Sequence__init(&msg->response, 0)) {
    tf2_msgs__srv__FrameGraph_Event__fini(msg);
    return false;
  }
  return true;
...
void
tf2_msgs__srv__FrameGraph_Event__fini(tf2_msgs__srv__FrameGraph_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  tf2_msgs__srv__FrameGraph_Request__Sequence__fini(&msg->request);
  // response
  tf2_msgs__srv__FrameGraph_Response__Sequence__fini(&msg->response);
}

bool
tf2_msgs__srv__FrameGraph_Event__are_equal(const tf2_msgs__srv__FrameGraph_Event * lhs, const tf2_msgs__srv__FrameGraph_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!tf2_msgs__srv__FrameGraph_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!tf2_msgs__srv__FrameGraph_Response__Sequence__are_equal(
  ...
  tf2_msgs__srv__FrameGraph_Event * output)
{
  ...
  // request
  if (!tf2_msgs__srv__FrameGraph_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!tf2_msgs__srv__FrameGraph_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tf2_msgs__srv__FrameGraph_Event * msg = (tf2_msgs__srv__FrameGraph_Event *)allocator.allocate(sizeof(tf2_msgs__srv__FrameGraph_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tf2_msgs__srv__FrameGraph_Event));
  bool success = tf2_msgs__srv__FrameGraph_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
tf2_msgs__srv__FrameGraph_Event__destroy(tf2_msgs__srv__FrameGraph_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tf2_msgs__srv__FrameGraph_Event__fini(msg);
...
bool
tf2_msgs__srv__FrameGraph_Event__Sequence__init(tf2_msgs__srv__FrameGraph_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tf2_msgs__srv__FrameGraph_Event * data = NULL;

  if (size) {
    data = (tf2_msgs__srv__FrameGraph_Event *)allocator.zero_allocate(size, sizeof(tf2_msgs__srv__FrameGraph_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tf2_msgs__srv__FrameGraph_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tf2_msgs__srv__FrameGraph_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
tf2_msgs__srv__FrameGraph_Event__Sequence__fini(tf2_msgs__srv__FrameGraph_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tf2_msgs__srv__FrameGraph_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
tf2_msgs__srv__FrameGraph_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tf2_msgs__srv__FrameGraph_Event__Sequence * array = (tf2_msgs__srv__FrameGraph_Event__Sequence *)allocator.allocate(sizeof(tf2_msgs__srv__FrameGraph_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tf2_msgs__srv__FrameGraph_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
tf2_msgs__srv__FrameGraph_Event__Sequence__destroy(tf2_msgs__srv__FrameGraph_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tf2_msgs__srv__FrameGraph_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
tf2_msgs__srv__FrameGraph_Event__Sequence__are_equal(const tf2_msgs__srv__FrameGraph_Event__Sequence * lhs, const tf2_msgs__srv__FrameGraph_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tf2_msgs__srv__FrameGraph_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
tf2_msgs__srv__FrameGraph_Event__Sequence__copy(
  const tf2_msgs__srv__FrameGraph_Event__Sequence * input,
  tf2_msgs__srv__FrameGraph_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tf2_msgs__srv__FrameGraph_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tf2_msgs__srv__FrameGraph_Event * data =
      (tf2_msgs__srv__FrameGraph_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tf2_msgs__srv__FrameGraph_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tf2_msgs__srv__FrameGraph_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tf2_msgs__srv__FrameGraph_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
