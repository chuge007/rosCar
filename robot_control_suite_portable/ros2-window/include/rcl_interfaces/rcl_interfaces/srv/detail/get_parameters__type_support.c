...
void rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  rcl_interfaces__srv__GetParameters_Event__init(message_memory);
}

void rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_fini_function(void * message_memory)
{
  rcl_interfaces__srv__GetParameters_Event__fini(message_memory);
}

size_t rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__size_function__GetParameters_Event__request(
  const void * untyped_member)
{
  const rcl_interfaces__srv__GetParameters_Request__Sequence * member =
    (const rcl_interfaces__srv__GetParameters_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__get_const_function__GetParameters_Event__request(
  const void * untyped_member, size_t index)
{
  const rcl_interfaces__srv__GetParameters_Request__Sequence * member =
    (const rcl_interfaces__srv__GetParameters_Request__Sequence *)(untyped_member);
...
void * rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__get_function__GetParameters_Event__request(
  void * untyped_member, size_t index)
{
  rcl_interfaces__srv__GetParameters_Request__Sequence * member =
    (rcl_interfaces__srv__GetParameters_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__fetch_function__GetParameters_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const rcl_interfaces__srv__GetParameters_Request * item =
    ((const rcl_interfaces__srv__GetParameters_Request *)
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__get_const_function__GetParameters_Event__request(untyped_member, index));
  rcl_interfaces__srv__GetParameters_Request * value =
    (rcl_interfaces__srv__GetParameters_Request *)(untyped_value);
  *value = *item;
}

void rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__assign_function__GetParameters_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  rcl_interfaces__srv__GetParameters_Request * item =
    ((rcl_interfaces__srv__GetParameters_Request *)
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__get_function__GetParameters_Event__request(untyped_member, index));
  const rcl_interfaces__srv__GetParameters_Request * value =
    (const rcl_interfaces__srv__GetParameters_Request *)(untyped_value);
  *item = *value;
}

bool rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__resize_function__GetParameters_Event__request(
  void * untyped_member, size_t size)
{
  rcl_interfaces__srv__GetParameters_Request__Sequence * member =
    (rcl_interfaces__srv__GetParameters_Request__Sequence *)(untyped_member);
  rcl_interfaces__srv__GetParameters_Request__Sequence__fini(member);
  return rcl_interfaces__srv__GetParameters_Request__Sequence__init(member, size);
}

size_t rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__size_function__GetParameters_Event__response(
  const void * untyped_member)
{
  const rcl_interfaces__srv__GetParameters_Response__Sequence * member =
    (const rcl_interfaces__srv__GetParameters_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__get_const_function__GetParameters_Event__response(
  const void * untyped_member, size_t index)
{
  const rcl_interfaces__srv__GetParameters_Response__Sequence * member =
    (const rcl_interfaces__srv__GetParameters_Response__Sequence *)(untyped_member);
...
void * rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__get_function__GetParameters_Event__response(
  void * untyped_member, size_t index)
{
  rcl_interfaces__srv__GetParameters_Response__Sequence * member =
    (rcl_interfaces__srv__GetParameters_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__fetch_function__GetParameters_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const rcl_interfaces__srv__GetParameters_Response * item =
    ((const rcl_interfaces__srv__GetParameters_Response *)
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__get_const_function__GetParameters_Event__response(untyped_member, index));
  rcl_interfaces__srv__GetParameters_Response * value =
    (rcl_interfaces__srv__GetParameters_Response *)(untyped_value);
  *value = *item;
}

void rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__assign_function__GetParameters_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  rcl_interfaces__srv__GetParameters_Response * item =
    ((rcl_interfaces__srv__GetParameters_Response *)
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__get_function__GetParameters_Event__response(untyped_member, index));
  const rcl_interfaces__srv__GetParameters_Response * value =
    (const rcl_interfaces__srv__GetParameters_Response *)(untyped_value);
  *item = *value;
}

bool rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__resize_function__GetParameters_Event__response(
  void * untyped_member, size_t size)
{
  rcl_interfaces__srv__GetParameters_Response__Sequence * member =
    (rcl_interfaces__srv__GetParameters_Response__Sequence *)(untyped_member);
  rcl_interfaces__srv__GetParameters_Response__Sequence__fini(member);
  return rcl_interfaces__srv__GetParameters_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcl_interfaces__srv__GetParameters_Event, info),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(rcl_interfaces__srv__GetParameters_Event, request),  // bytes offset in struct
    NULL,  // default value
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__size_function__GetParameters_Event__request,  // size() function pointer
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__get_const_function__GetParameters_Event__request,  // get_const(index) function pointer
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__get_function__GetParameters_Event__request,  // get(index) function pointer
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__fetch_function__GetParameters_Event__request,  // fetch(index, &value) function pointer
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__assign_function__GetParameters_Event__request,  // assign(index, value) function pointer
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__resize_function__GetParameters_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(rcl_interfaces__srv__GetParameters_Event, response),  // bytes offset in struct
    NULL,  // default value
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__size_function__GetParameters_Event__response,  // size() function pointer
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__get_const_function__GetParameters_Event__response,  // get_const(index) function pointer
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__get_function__GetParameters_Event__response,  // get(index) function pointer
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__fetch_function__GetParameters_Event__response,  // fetch(index, &value) function pointer
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__assign_function__GetParameters_Event__response,  // assign(index, value) function pointer
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__resize_function__GetParameters_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_message_members = {
  "rcl_interfaces__srv",  // message namespace
  "GetParameters_Event",  // message name
  3,  // number of fields
  sizeof(rcl_interfaces__srv__GetParameters_Event),
  false,  // has_any_key_member_
  rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_message_member_array,  // message members
  rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_message_type_support_handle = {
  0,
  &rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rcl_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameters_Event)() {
  rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameters_Request)();
  rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameters_Response)();
  if (!rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_message_type_support_handle.typesupport_identifier) {
    rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &rcl_interfaces__srv__GetParameters_Event__rosidl_typesupport_introspection_c__GetParameters_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t rcl_interfaces__srv__detail__get_parameters__rosidl_typesupport_introspection_c__GetParameters_service_type_support_handle = {
  ...
  &rcl_interfaces__srv__GetParameters_Request__rosidl_typesupport_introspection_c__GetParameters_Request_message_type_support_handle,
  &rcl_interfaces__srv__GetParameters_Response__rosidl_typesupport_introspection_c__GetParameters_Response_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameters_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameters_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameters_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rcl_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameters)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, srv, GetParameters_Event)()->data;
  }
