...
inline std::string to_yaml(const GetParameters_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use rcl_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rcl_interfaces::srv::GetParameters_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rcl_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rcl_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const rcl_interfaces::srv::GetParameters_Event & msg)
{
  return rcl_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rcl_interfaces::srv::GetParameters_Event>()
{
  return "rcl_interfaces::srv::GetParameters_Event";
}

template<>
inline const char * name<rcl_interfaces::srv::GetParameters_Event>()
{
  return "rcl_interfaces/srv/GetParameters_Event";
}

template<>
struct has_fixed_size<rcl_interfaces::srv::GetParameters_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rcl_interfaces::srv::GetParameters_Event>
  : std::integral_constant<bool, has_bounded_size<rcl_interfaces::srv::GetParameters_Request>::value && has_bounded_size<rcl_interfaces::srv::GetParameters_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<rcl_interfaces::srv::GetParameters_Event>
  : std::true_type {};
