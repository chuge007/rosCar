...
[[deprecated("use rcl_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rcl_interfaces::srv::GetLoggerLevels_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rcl_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rcl_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const rcl_interfaces::srv::GetLoggerLevels_Event & msg)
{
  return rcl_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rcl_interfaces::srv::GetLoggerLevels_Event>()
{
  return "rcl_interfaces::srv::GetLoggerLevels_Event";
}

template<>
inline const char * name<rcl_interfaces::srv::GetLoggerLevels_Event>()
{
  return "rcl_interfaces/srv/GetLoggerLevels_Event";
}
