...
inline void to_yaml(
  const rcl_interfaces::msg::SetLoggerLevelsResult & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rcl_interfaces::msg::SetLoggerLevelsResult & msg)
{
  return rcl_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rcl_interfaces::msg::SetLoggerLevelsResult>()
{
  return "rcl_interfaces::msg::SetLoggerLevelsResult";
}

template<>
inline const char * name<rcl_interfaces::msg::SetLoggerLevelsResult>()
{
  return "rcl_interfaces/msg/SetLoggerLevelsResult";
}
