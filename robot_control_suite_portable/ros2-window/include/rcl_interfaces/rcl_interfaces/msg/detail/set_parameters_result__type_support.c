...
void rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_init_function(
...
void rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_fini_function(void * message_memory)
{
  rcl_interfaces__msg__SetParametersResult__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_message_member_array[2] = {
  {
    "successful",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_message_members = {
...
static rosidl_message_type_support_t rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, msg, SetParametersResult)() {
  if (!rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_message_type_support_handle.typesupport_identifier) {
    rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &rcl_interfaces__msg__SetParametersResult__rosidl_typesupport_introspection_c__SetParametersResult_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
