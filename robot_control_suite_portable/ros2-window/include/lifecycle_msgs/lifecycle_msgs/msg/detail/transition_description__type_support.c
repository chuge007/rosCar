...
void lifecycle_msgs__msg__TransitionDescription__rosidl_typesupport_introspection_c__TransitionDescription_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  lifecycle_msgs__msg__TransitionDescription__init(message_memory);
}

void lifecycle_msgs__msg__TransitionDescription__rosidl_typesupport_introspection_c__TransitionDescription_fini_function(void * message_memory)
{
  lifecycle_msgs__msg__TransitionDescription__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember lifecycle_msgs__msg__TransitionDescription__rosidl_typesupport_introspection_c__TransitionDescription_message_member_array[3] = {
  {
    "transition",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers lifecycle_msgs__msg__TransitionDescription__rosidl_typesupport_introspection_c__TransitionDescription_message_members = {
...
static rosidl_message_type_support_t lifecycle_msgs__msg__TransitionDescription__rosidl_typesupport_introspection_c__TransitionDescription_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lifecycle_msgs, msg, TransitionDescription)() {
  lifecycle_msgs__msg__TransitionDescription__rosidl_typesupport_introspection_c__TransitionDescription_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lifecycle_msgs, msg, Transition)();
  lifecycle_msgs__msg__TransitionDescription__rosidl_typesupport_introspection_c__TransitionDescription_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lifecycle_msgs, msg, State)();
  lifecycle_msgs__msg__TransitionDescription__rosidl_typesupport_introspection_c__TransitionDescription_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lifecycle_msgs, msg, State)();
  if (!lifecycle_msgs__msg__TransitionDescription__rosidl_typesupport_introspection_c__TransitionDescription_message_type_support_handle.typesupport_identifier) {
    lifecycle_msgs__msg__TransitionDescription__rosidl_typesupport_introspection_c__TransitionDescription_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &lifecycle_msgs__msg__TransitionDescription__rosidl_typesupport_introspection_c__TransitionDescription_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
