...
static char ros2cli_test_interfaces__msg__ShortVariedNested__FIELD_NAME__short_varied[] = "short_varied";

static rosidl_runtime_c__type_description__Field ros2cli_test_interfaces__msg__ShortVariedNested__FIELDS[] = {
  {
    {ros2cli_test_interfaces__msg__ShortVariedNested__FIELD_NAME__short_varied, 12, 12},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ros2cli_test_interfaces__msg__ShortVariedNested__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {ros2cli_test_interfaces__msg__ShortVaried__TYPE_NAME, 39, 39},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {ros2cli_test_interfaces__msg__ShortVariedNested__FIELDS, 1, 1},
    },
    {ros2cli_test_interfaces__msg__ShortVariedNested__REFERENCED_TYPE_DESCRIPTIONS, 1, 1},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ros2cli_test_interfaces__msg__ShortVariedNested__get_individual_type_description_source(NULL),
