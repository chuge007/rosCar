...
[[deprecated("use ros2cli_test_interfaces::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ros2cli_test_interfaces::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ros2cli_test_interfaces::action::to_yaml() instead")]]
inline std::string to_yaml(const ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Event & msg)
{
  return ros2cli_test_interfaces::action::to_yaml(msg);
}
...
[[deprecated("use ros2cli_test_interfaces::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ros2cli_test_interfaces::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ros2cli_test_interfaces::action::to_yaml() instead")]]
inline std::string to_yaml(const ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Event & msg)
{
  return ros2cli_test_interfaces::action::to_yaml(msg);
}
