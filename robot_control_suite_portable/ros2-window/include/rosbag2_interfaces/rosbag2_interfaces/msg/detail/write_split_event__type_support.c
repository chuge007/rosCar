...
static rosidl_typesupport_introspection_c__MessageMember rosbag2_interfaces__msg__WriteSplitEvent__rosidl_typesupport_introspection_c__WriteSplitEvent_message_member_array[3] = {
  {
    "closed_file",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosbag2_interfaces__msg__WriteSplitEvent, node_name),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
