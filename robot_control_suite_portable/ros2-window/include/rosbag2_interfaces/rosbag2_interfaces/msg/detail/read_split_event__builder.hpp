...
class Init_ReadSplitEvent_node_name
{
public:
  explicit Init_ReadSplitEvent_node_name(::rosbag2_interfaces::msg::ReadSplitEvent & msg)
  : msg_(msg)
  {}
  ::rosbag2_interfaces::msg::ReadSplitEvent node_name(::rosbag2_interfaces::msg::ReadSplitEvent::_node_name_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_ReadSplitEvent_node_name opened_file(::rosbag2_interfaces::msg::ReadSplitEvent::_opened_file_type arg)
  {
    msg_.opened_file = std::move(arg);
    return Init_ReadSplitEvent_node_name(msg_);
  }
