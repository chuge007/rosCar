...
[[deprecated("use rosbag2_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rosbag2_interfaces::srv::IsPaused_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rosbag2_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rosbag2_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const rosbag2_interfaces::srv::IsPaused_Event & msg)
{
  return rosbag2_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rosbag2_interfaces::srv::IsPaused_Event>()
{
  return "rosbag2_interfaces::srv::IsPaused_Event";
}

template<>
inline const char * name<rosbag2_interfaces::srv::IsPaused_Event>()
{
  return "rosbag2_interfaces/srv/IsPaused_Event";
}
