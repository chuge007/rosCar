...
enum
{
  rosbag2_interfaces__srv__PlayNext_Event__request__MAX_SIZE = 1
};
// response
enum
{
  rosbag2_interfaces__srv__PlayNext_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/PlayNext in the package rosbag2_interfaces.
typedef struct rosbag2_interfaces__srv__PlayNext_Event
{
  service_msgs__msg__ServiceEventInfo info;
  rosbag2_interfaces__srv__PlayNext_Request__Sequence request;
  rosbag2_interfaces__srv__PlayNext_Response__Sequence response;
} rosbag2_interfaces__srv__PlayNext_Event;

// Struct for a sequence of rosbag2_interfaces__srv__PlayNext_Event.
typedef struct rosbag2_interfaces__srv__PlayNext_Event__Sequence
{
