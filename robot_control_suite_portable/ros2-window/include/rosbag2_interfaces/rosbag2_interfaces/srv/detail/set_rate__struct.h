...
enum
{
  rosbag2_interfaces__srv__SetRate_Event__request__MAX_SIZE = 1
};
// response
enum
{
  rosbag2_interfaces__srv__SetRate_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetRate in the package rosbag2_interfaces.
typedef struct rosbag2_interfaces__srv__SetRate_Event
{
  service_msgs__msg__ServiceEventInfo info;
  rosbag2_interfaces__srv__SetRate_Request__Sequence request;
  rosbag2_interfaces__srv__SetRate_Response__Sequence response;
} rosbag2_interfaces__srv__SetRate_Event;

// Struct for a sequence of rosbag2_interfaces__srv__SetRate_Event.
typedef struct rosbag2_interfaces__srv__SetRate_Event__Sequence
{
