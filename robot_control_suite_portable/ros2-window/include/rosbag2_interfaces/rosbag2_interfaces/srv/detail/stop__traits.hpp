...
inline void to_yaml(
  const rosbag2_interfaces::srv::Stop_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosbag2_interfaces::srv::Stop_Request & msg)
{
  return rosbag2_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rosbag2_interfaces::srv::Stop_Request>()
{
  return "rosbag2_interfaces::srv::Stop_Request";
}

template<>
inline const char * name<rosbag2_interfaces::srv::Stop_Request>()
{
  return "rosbag2_interfaces/srv/Stop_Request";
}
...
[[deprecated("use rosbag2_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rosbag2_interfaces::srv::Stop_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  rosbag2_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rosbag2_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const rosbag2_interfaces::srv::Stop_Response & msg)
{
  return rosbag2_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rosbag2_interfaces::srv::Stop_Response>()
{
  return "rosbag2_interfaces::srv::Stop_Response";
}

template<>
inline const char * name<rosbag2_interfaces::srv::Stop_Response>()
{
  return "rosbag2_interfaces/srv/Stop_Response";
}
...
[[deprecated("use rosbag2_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rosbag2_interfaces::srv::Stop_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rosbag2_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rosbag2_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const rosbag2_interfaces::srv::Stop_Event & msg)
{
  return rosbag2_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rosbag2_interfaces::srv::Stop_Event>()
{
  return "rosbag2_interfaces::srv::Stop_Event";
}

template<>
inline const char * name<rosbag2_interfaces::srv::Stop_Event>()
{
  return "rosbag2_interfaces/srv/Stop_Event";
}
...
template<>
inline const char * data_type<rosbag2_interfaces::srv::Stop>()
{
  return "rosbag2_interfaces::srv::Stop";
}

template<>
inline const char * name<rosbag2_interfaces::srv::Stop>()
{
  return "rosbag2_interfaces/srv/Stop";
}
