...
inline void to_yaml(
  const rosbag2_interfaces::srv::Play_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosbag2_interfaces::srv::Play_Request & msg)
{
  return rosbag2_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rosbag2_interfaces::srv::Play_Request>()
{
  return "rosbag2_interfaces::srv::Play_Request";
}

template<>
inline const char * name<rosbag2_interfaces::srv::Play_Request>()
{
  return "rosbag2_interfaces/srv/Play_Request";
}
...
[[deprecated("use rosbag2_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rosbag2_interfaces::srv::Play_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  rosbag2_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rosbag2_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const rosbag2_interfaces::srv::Play_Response & msg)
{
  return rosbag2_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rosbag2_interfaces::srv::Play_Response>()
{
  return "rosbag2_interfaces::srv::Play_Response";
}

template<>
inline const char * name<rosbag2_interfaces::srv::Play_Response>()
{
  return "rosbag2_interfaces/srv/Play_Response";
}
...
[[deprecated("use rosbag2_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rosbag2_interfaces::srv::Play_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rosbag2_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rosbag2_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const rosbag2_interfaces::srv::Play_Event & msg)
{
  return rosbag2_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rosbag2_interfaces::srv::Play_Event>()
{
  return "rosbag2_interfaces::srv::Play_Event";
}

template<>
inline const char * name<rosbag2_interfaces::srv::Play_Event>()
{
  return "rosbag2_interfaces/srv/Play_Event";
}
...
template<>
inline const char * data_type<rosbag2_interfaces::srv::Play>()
{
  return "rosbag2_interfaces::srv::Play";
}

template<>
inline const char * name<rosbag2_interfaces::srv::Play>()
{
  return "rosbag2_interfaces/srv/Play";
}
