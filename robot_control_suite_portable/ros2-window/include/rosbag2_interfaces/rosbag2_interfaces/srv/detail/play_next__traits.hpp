...
inline std::string to_yaml(const PlayNext_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use rosbag2_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rosbag2_interfaces::srv::PlayNext_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rosbag2_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rosbag2_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const rosbag2_interfaces::srv::PlayNext_Event & msg)
{
  return rosbag2_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rosbag2_interfaces::srv::PlayNext_Event>()
{
  return "rosbag2_interfaces::srv::PlayNext_Event";
}

template<>
inline const char * name<rosbag2_interfaces::srv::PlayNext_Event>()
{
  return "rosbag2_interfaces/srv/PlayNext_Event";
}

template<>
struct has_fixed_size<rosbag2_interfaces::srv::PlayNext_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rosbag2_interfaces::srv::PlayNext_Event>
  : std::integral_constant<bool, has_bounded_size<rosbag2_interfaces::srv::PlayNext_Request>::value && has_bounded_size<rosbag2_interfaces::srv::PlayNext_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<rosbag2_interfaces::srv::PlayNext_Event>
  : std::true_type {};
