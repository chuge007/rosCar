...
void fetch_function__MultiDOFJointTrajectoryPoint__transforms(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Transform *>(
    get_const_function__MultiDOFJointTrajectoryPoint__transforms(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Transform *>(untyped_value);
  value = item;
}

void assign_function__MultiDOFJointTrajectoryPoint__transforms(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Transform *>(
    get_function__MultiDOFJointTrajectoryPoint__transforms(untyped_member, index));
...
void fetch_function__MultiDOFJointTrajectoryPoint__velocities(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Twist *>(
    get_const_function__MultiDOFJointTrajectoryPoint__velocities(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Twist *>(untyped_value);
  value = item;
}

void assign_function__MultiDOFJointTrajectoryPoint__velocities(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Twist *>(
    get_function__MultiDOFJointTrajectoryPoint__velocities(untyped_member, index));
...
void fetch_function__MultiDOFJointTrajectoryPoint__accelerations(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Twist *>(
    get_const_function__MultiDOFJointTrajectoryPoint__accelerations(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Twist *>(untyped_value);
  value = item;
}

void assign_function__MultiDOFJointTrajectoryPoint__accelerations(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Twist *>(
    get_function__MultiDOFJointTrajectoryPoint__accelerations(untyped_member, index));
  const auto & value = *reinterpret_cast<const geometry_msgs::msg::Twist *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MultiDOFJointTrajectoryPoint_message_member_array[4] = {
  {
    ...
    fetch_function__MultiDOFJointTrajectoryPoint__transforms,  // fetch(index, &value) function pointer
    assign_function__MultiDOFJointTrajectoryPoint__transforms,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__MultiDOFJointTrajectoryPoint__velocities,  // fetch(index, &value) function pointer
    assign_function__MultiDOFJointTrajectoryPoint__velocities,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__MultiDOFJointTrajectoryPoint__accelerations,  // fetch(index, &value) function pointer
    assign_function__MultiDOFJointTrajectoryPoint__accelerations,  // assign(index, value) function pointer
