...
#ifndef STATISTICS_MSGS__MSG__DETAIL__STATISTIC_DATA_POINT__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
#define STATISTICS_MSGS__MSG__DETAIL__STATISTIC_DATA_POINT__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
...
bool cdr_serialize_statistics_msgs__msg__StatisticDataPoint(
  const statistics_msgs__msg__StatisticDataPoint * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_statistics_msgs
bool cdr_deserialize_statistics_msgs__msg__StatisticDataPoint(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_statistics_msgs
bool cdr_serialize_key_statistics_msgs__msg__StatisticDataPoint(
  const statistics_msgs__msg__StatisticDataPoint * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_statistics_msgs
size_t get_serialized_size_key_statistics_msgs__msg__StatisticDataPoint(
  const void * untyped_ros_message,
  size_t current_alignment);

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_statistics_msgs
size_t max_serialized_size_key_statistics_msgs__msg__StatisticDataPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
#endif  // STATISTICS_MSGS__MSG__DETAIL__STATISTIC_DATA_POINT__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
