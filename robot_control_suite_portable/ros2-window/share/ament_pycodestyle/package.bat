...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ament_pycodestyle\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ament_pycodestyle\hook\pythonscriptspath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ament_pycodestyle\hook\ament_prefix_path.bat"
