...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_dynamic_typesupport]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_dynamic_typesupport] "%AMENT_CURRENT_PREFIX%\share\rosidl_dynamic_typesupport\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_dynamic_typesupport] "%AMENT_CURRENT_PREFIX%\share\rosidl_dynamic_typesupport\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_dynamic_typesupport]:;=";"%") do (
    call:call_file %%f
  )
