...
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\liblz4_vendor\bin"
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\liblz4_vendor\lib"
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\liblz4_vendor\lib64"
