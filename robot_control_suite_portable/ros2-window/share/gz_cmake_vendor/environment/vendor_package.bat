...
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\gz_cmake_vendor\bin"
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\gz_cmake_vendor\lib"
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\gz_cmake_vendor\lib64"
