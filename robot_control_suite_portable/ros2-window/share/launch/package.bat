...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\launch\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\launch\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\launch\hook\pythonscriptspath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\launch\hook\ament_prefix_path.bat"
