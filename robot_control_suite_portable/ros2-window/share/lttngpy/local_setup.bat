...
set "AMENT_ENVIRONMENT_HOOKS[lttngpy]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[lttngpy] "%AMENT_CURRENT_PREFIX%\share\lttngpy\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[lttngpy] "%AMENT_CURRENT_PREFIX%\share\lttngpy\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[lttngpy] "%AMENT_CURRENT_PREFIX%\share\lttngpy\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[lttngpy]:;=";"%") do (
    call:call_file %%f
  )
