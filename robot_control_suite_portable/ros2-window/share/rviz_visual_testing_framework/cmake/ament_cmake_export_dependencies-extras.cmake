...
set(_exported_dependencies "geometry_msgs;Qt5;rclcpp;rcutils;rviz_common;rviz_ogre_vendor;rviz_rendering;std_msgs;tf2;tf2_ros")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rviz_visual_testing_framework_INCLUDE_DIRS "${_include_dirs}")
          endif()
