...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ament_lint\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ament_lint\hook\pythonscriptspath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ament_lint\hook\ament_prefix_path.bat"
