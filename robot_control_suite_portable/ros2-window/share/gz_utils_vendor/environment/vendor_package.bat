...
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\gz_utils_vendor\bin"
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\gz_utils_vendor\lib"
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\gz_utils_vendor\lib64"
