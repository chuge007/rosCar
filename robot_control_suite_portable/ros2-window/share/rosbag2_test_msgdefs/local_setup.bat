...
set "AMENT_ENVIRONMENT_HOOKS[rosbag2_test_msgdefs]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_test_msgdefs] "%AMENT_CURRENT_PREFIX%\share\rosbag2_test_msgdefs\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_test_msgdefs] "%AMENT_CURRENT_PREFIX%\share\rosbag2_test_msgdefs\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_test_msgdefs] "%AMENT_CURRENT_PREFIX%\share\rosbag2_test_msgdefs\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosbag2_test_msgdefs]:;=";"%") do (
    call:call_file %%f
  )
