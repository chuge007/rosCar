...
set "AMENT_ENVIRONMENT_HOOKS[point_cloud_transport_py]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[point_cloud_transport_py] "%AMENT_CURRENT_PREFIX%\share\point_cloud_transport_py\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[point_cloud_transport_py] "%AMENT_CURRENT_PREFIX%\share\point_cloud_transport_py\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[point_cloud_transport_py] "%AMENT_CURRENT_PREFIX%\share\point_cloud_transport_py\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[point_cloud_transport_py]:;=";"%") do (
    call:call_file %%f
  )
