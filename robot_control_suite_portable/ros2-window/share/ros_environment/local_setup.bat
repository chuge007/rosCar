...
set "AMENT_ENVIRONMENT_HOOKS[ros_environment]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros_environment] "%AMENT_CURRENT_PREFIX%\share\ros_environment\environment\1.ros_discovery.bat"
...
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros_environment] "%AMENT_CURRENT_PREFIX%\share\ros_environment\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ros_environment]:;=";"%") do (
    call:call_file %%f
  )
