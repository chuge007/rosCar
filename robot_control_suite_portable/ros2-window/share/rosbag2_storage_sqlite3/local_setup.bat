...
set "AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_sqlite3]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_sqlite3] "%AMENT_CURRENT_PREFIX%\share\rosbag2_storage_sqlite3\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_sqlite3] "%AMENT_CURRENT_PREFIX%\share\rosbag2_storage_sqlite3\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_sqlite3] "%AMENT_CURRENT_PREFIX%\share\rosbag2_storage_sqlite3\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_sqlite3]:;=";"%") do (
    call:call_file %%f
  )
