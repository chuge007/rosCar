...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ament_cmake\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ament_cmake\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ament_cmake\hook\pythonscriptspath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/ament_cmake/local_setup.bat"
