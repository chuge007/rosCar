...
set "AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_mcap]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_mcap] "%AMENT_CURRENT_PREFIX%\share\rosbag2_storage_mcap\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_mcap] "%AMENT_CURRENT_PREFIX%\share\rosbag2_storage_mcap\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_mcap] "%AMENT_CURRENT_PREFIX%\share\rosbag2_storage_mcap\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosbag2_storage_mcap]:;=";"%") do (
    call:call_file %%f
  )
