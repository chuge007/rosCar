...
set "AMENT_ENVIRONMENT_HOOKS[mimick_vendor]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mimick_vendor] "%AMENT_CURRENT_PREFIX%\share\mimick_vendor\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mimick_vendor] "%AMENT_CURRENT_PREFIX%\share\mimick_vendor\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mimick_vendor] "%AMENT_CURRENT_PREFIX%\share\mimick_vendor\environment\vendor_package.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[mimick_vendor]:;=";"%") do (
    call:call_file %%f
  )
