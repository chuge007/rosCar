...
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\mimick_vendor\lib"
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\mimick_vendor\lib64"
