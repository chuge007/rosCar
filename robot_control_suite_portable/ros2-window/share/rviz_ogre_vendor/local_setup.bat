...
set "AMENT_ENVIRONMENT_HOOKS[rviz_ogre_vendor]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rviz_ogre_vendor] "%AMENT_CURRENT_PREFIX%\share\rviz_ogre_vendor\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rviz_ogre_vendor] "%AMENT_CURRENT_PREFIX%\share\rviz_ogre_vendor\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rviz_ogre_vendor] "%AMENT_CURRENT_PREFIX%\share\rviz_ogre_vendor\environment\vendor_package.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rviz_ogre_vendor]:;=";"%") do (
    call:call_file %%f
  )
