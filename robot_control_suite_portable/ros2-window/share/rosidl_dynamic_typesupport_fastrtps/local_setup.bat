...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_dynamic_typesupport_fastrtps]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_dynamic_typesupport_fastrtps] "%AMENT_CURRENT_PREFIX%\share\rosidl_dynamic_typesupport_fastrtps\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_dynamic_typesupport_fastrtps] "%AMENT_CURRENT_PREFIX%\share\rosidl_dynamic_typesupport_fastrtps\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_dynamic_typesupport_fastrtps]:;=";"%") do (
    call:call_file %%f
  )
