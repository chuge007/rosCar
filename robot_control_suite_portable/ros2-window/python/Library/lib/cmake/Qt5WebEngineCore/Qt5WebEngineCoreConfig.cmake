...
set(Qt5WebEngineCore_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::WebEngineCore)
    ...
    set(Qt5WebEngineCore_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineCore_install_prefix}/include/qt/QtWebEngineCore/5.15.8"
        "${_qt5WebEngineCore_install_prefix}/include/qt/QtWebEngineCore/5.15.8/QtWebEngineCore"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngineCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5WebEngineCore_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::WebEngineCore
                 ...
                 webengine-printing-and-pdf;webengine-kerberos;webengine-pepper-plugins;webengine-v8-snapshot-support;webengine-webrtc)
    set_property(TARGET Qt5::WebEngineCore
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 webengine-alsa;webengine-embedded-build;webengine-ozone;webengine-poppler-cpp;webengine-proprietary-codecs;webengine-pulseaudio;webengine-webrtc-pipewire)
    ...
    _populate_WebEngineCore_target_properties(RELEASE "Qt5WebEngineCore_conda.dll" "Qt5WebEngineCore_conda.lib" FALSE)

    if (EXISTS
        "${_qt5WebEngineCore_install_prefix}/bin/Qt5WebEngineCore_condad.dll"
      AND EXISTS
        "${_qt5WebEngineCore_install_prefix}/lib/Qt5WebEngineCore_condad.lib" )
        _populate_WebEngineCore_target_properties(DEBUG "Qt5WebEngineCore_condad.dll" "Qt5WebEngineCore_condad.lib" FALSE)
    endif()
