...
set(Qt5Pdf_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::Pdf)
    ...
    set(_Qt5Pdf_OWN_INCLUDE_DIRS "${_qt5Pdf_install_prefix}/include/qt/" "${_qt5Pdf_install_prefix}/include/qt/QtPdf")
    set(Qt5Pdf_PRIVATE_INCLUDE_DIRS
        "${_qt5Pdf_install_prefix}/include/qt/QtPdf/5.15.8"
        "${_qt5Pdf_install_prefix}/include/qt/QtPdf/5.15.8/QtPdf"
    )
    ...
    foreach(_module_dep ${_Qt5Pdf_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5Pdf_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Pdf
                 ...
                 pdf-bitcode;pdf-static-runtime;pdf-v8;pdf-xfa;pdf-xfa-bmp;pdf-xfa-gif;pdf-xfa-png;pdf-xfa-tiff)
    ...
    _populate_Pdf_target_properties(RELEASE "Qt5Pdf_conda.dll" "Qt5Pdf_conda.lib" FALSE)

    if (EXISTS
        "${_qt5Pdf_install_prefix}/bin/Qt5Pdf_condad.dll"
      AND EXISTS
        "${_qt5Pdf_install_prefix}/lib/Qt5Pdf_condad.lib" )
        _populate_Pdf_target_properties(DEBUG "Qt5Pdf_condad.dll" "Qt5Pdf_condad.lib" FALSE)
    endif()
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::Pdf AND NOT TARGET Qt::Pdf)
