...
set_target_properties(pcre2::pcre2grep PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/pcre2grep.exe"
  )
...
set_target_properties(pcre2::pcre2test PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/pcre2test.exe"
  )

list(APPEND _cmake_import_check_targets pcre2::pcre2test )
list(APPEND _cmake_import_check_files_for_pcre2::pcre2test "${_IMPORT_PREFIX}/bin/pcre2test.exe" )
