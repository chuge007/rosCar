...
set(Qt5PdfWidgets_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::PdfWidgets)
    ...
    set(Qt5PdfWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5PdfWidgets_install_prefix}/include/qt/QtPdfWidgets/5.15.8"
        "${_qt5PdfWidgets_install_prefix}/include/qt/QtPdfWidgets/5.15.8/QtPdfWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5PdfWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5PdfWidgets_FIND_VERSION_EXACT}
    ...
    _populate_PdfWidgets_target_properties(RELEASE "Qt5PdfWidgets_conda.dll" "Qt5PdfWidgets_conda.lib" FALSE)

    if (EXISTS
        "${_qt5PdfWidgets_install_prefix}/bin/Qt5PdfWidgets_condad.dll"
      AND EXISTS
        "${_qt5PdfWidgets_install_prefix}/lib/Qt5PdfWidgets_condad.lib" )
        _populate_PdfWidgets_target_properties(DEBUG "Qt5PdfWidgets_condad.dll" "Qt5PdfWidgets_condad.lib" FALSE)
    endif()
