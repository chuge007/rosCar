...
set(Qt5WebEngineWidgets_VERSION_STRING 5.15.8)
...
if (NOT TARGET Qt5::WebEngineWidgets)
    ...
    set(Qt5WebEngineWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineWidgets_install_prefix}/include/qt/QtWebEngineWidgets/5.15.8"
        "${_qt5WebEngineWidgets_install_prefix}/include/qt/QtWebEngineWidgets/5.15.8/QtWebEngineWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngineWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.8 ${_Qt5WebEngineWidgets_FIND_VERSION_EXACT}
    ...
    _populate_WebEngineWidgets_target_properties(RELEASE "Qt5WebEngineWidgets_conda.dll" "Qt5WebEngineWidgets_conda.lib" FALSE)

    if (EXISTS
        "${_qt5WebEngineWidgets_install_prefix}/bin/Qt5WebEngineWidgets_condad.dll"
      AND EXISTS
        "${_qt5WebEngineWidgets_install_prefix}/lib/Qt5WebEngineWidgets_condad.lib" )
        _populate_WebEngineWidgets_target_properties(DEBUG "Qt5WebEngineWidgets_condad.dll" "Qt5WebEngineWidgets_condad.lib" FALSE)
    endif()
