...
class Metaclass_SelfTest_Event(type):
    """Metaclass of message 'SelfTest_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__self_test__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__self_test__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__self_test__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__self_test__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__self_test__event
...
class SelfTest_Event(metaclass=Metaclass_SelfTest_Event):
    """Message class 'SelfTest_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<diagnostic_msgs/SelfTest_Request, 1>',
        'response': 'sequence<diagnostic_msgs/SelfTest_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['diagnostic_msgs', 'srv'], 'SelfTest_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['diagnostic_msgs', 'srv'], 'SelfTest_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from diagnostic_msgs.srv import SelfTest_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SelfTest_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SelfTest_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from diagnostic_msgs.srv import SelfTest_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SelfTest_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SelfTest_Response'"
...
class Metaclass_SelfTest(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _self_test.Metaclass_SelfTest_Event._TYPE_SUPPORT is None:
                _self_test.Metaclass_SelfTest_Event.__import_type_support__()
...
class SelfTest(metaclass=Metaclass_SelfTest):
    ...
    from diagnostic_msgs.srv._self_test import SelfTest_Event as Event
