...
bool nav_msgs__msg__goals__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav_msgs.msg._goals.Goals", full_classname_dest, 25) == 0);
  }
  nav_msgs__msg__Goals * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Goals */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav_msgs.msg._goals");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Goals");
  ...
  nav_msgs__msg__Goals * ros_message = (nav_msgs__msg__Goals *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
