...
class Metaclass_SetMap_Event(type):
    """Metaclass of message 'SetMap_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_map__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_map__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_map__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_map__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_map__event
...
class SetMap_Event(metaclass=Metaclass_SetMap_Event):
    """Message class 'SetMap_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<nav_msgs/SetMap_Request, 1>',
        'response': 'sequence<nav_msgs/SetMap_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['nav_msgs', 'srv'], 'SetMap_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['nav_msgs', 'srv'], 'SetMap_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from nav_msgs.srv import SetMap_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetMap_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetMap_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from nav_msgs.srv import SetMap_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetMap_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetMap_Response'"
...
class Metaclass_SetMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_map.Metaclass_SetMap_Event._TYPE_SUPPORT is None:
                _set_map.Metaclass_SetMap_Event.__import_type_support__()
...
class SetMap(metaclass=Metaclass_SetMap):
    ...
    from nav_msgs.srv._set_map import SetMap_Event as Event
