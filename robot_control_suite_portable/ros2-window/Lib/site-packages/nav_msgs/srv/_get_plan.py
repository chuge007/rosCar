...
class Metaclass_GetPlan_Event(type):
    """Metaclass of message 'GetPlan_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_plan__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_plan__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_plan__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_plan__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_plan__event
...
class GetPlan_Event(metaclass=Metaclass_GetPlan_Event):
    """Message class 'GetPlan_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<nav_msgs/GetPlan_Request, 1>',
        'response': 'sequence<nav_msgs/GetPlan_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['nav_msgs', 'srv'], 'GetPlan_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['nav_msgs', 'srv'], 'GetPlan_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from nav_msgs.srv import GetPlan_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetPlan_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetPlan_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from nav_msgs.srv import GetPlan_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetPlan_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetPlan_Response'"
...
class Metaclass_GetPlan(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_plan.Metaclass_GetPlan_Event._TYPE_SUPPORT is None:
                _get_plan.Metaclass_GetPlan_Event.__import_type_support__()
...
class GetPlan(metaclass=Metaclass_GetPlan):
    ...
    from nav_msgs.srv._get_plan import GetPlan_Event as Event
