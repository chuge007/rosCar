...
class Metaclass_GetMap_Event(type):
    """Metaclass of message 'GetMap_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_map__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_map__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_map__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_map__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_map__event
...
class GetMap_Event(metaclass=Metaclass_GetMap_Event):
    """Message class 'GetMap_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<nav_msgs/GetMap_Request, 1>',
        'response': 'sequence<nav_msgs/GetMap_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['nav_msgs', 'srv'], 'GetMap_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['nav_msgs', 'srv'], 'GetMap_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from nav_msgs.srv import GetMap_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetMap_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetMap_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from nav_msgs.srv import GetMap_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetMap_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetMap_Response'"
...
class Metaclass_GetMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from nav_msgs.srv import _get_map
            ...
            if _get_map.Metaclass_GetMap_Event._TYPE_SUPPORT is None:
                _get_map.Metaclass_GetMap_Event.__import_type_support__()


class GetMap(metaclass=Metaclass_GetMap):
    from nav_msgs.srv._get_map import GetMap_Request as Request
    from nav_msgs.srv._get_map import GetMap_Response as Response
    from nav_msgs.srv._get_map import GetMap_Event as Event
