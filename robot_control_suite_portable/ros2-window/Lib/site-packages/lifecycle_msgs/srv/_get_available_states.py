...
class Metaclass_GetAvailableStates_Event(type):
    """Metaclass of message 'GetAvailableStates_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_available_states__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_available_states__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_available_states__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_available_states__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_available_states__event
...
class GetAvailableStates_Event(metaclass=Metaclass_GetAvailableStates_Event):
    """Message class 'GetAvailableStates_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<lifecycle_msgs/GetAvailableStates_Request, 1>',
        'response': 'sequence<lifecycle_msgs/GetAvailableStates_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lifecycle_msgs', 'srv'], 'GetAvailableStates_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lifecycle_msgs', 'srv'], 'GetAvailableStates_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from lifecycle_msgs.srv import GetAvailableStates_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetAvailableStates_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetAvailableStates_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from lifecycle_msgs.srv import GetAvailableStates_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetAvailableStates_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetAvailableStates_Response'"
...
class Metaclass_GetAvailableStates(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_available_states.Metaclass_GetAvailableStates_Event._TYPE_SUPPORT is None:
                _get_available_states.Metaclass_GetAvailableStates_Event.__import_type_support__()
...
class GetAvailableStates(metaclass=Metaclass_GetAvailableStates):
    ...
    from lifecycle_msgs.srv._get_available_states import GetAvailableStates_Event as Event
