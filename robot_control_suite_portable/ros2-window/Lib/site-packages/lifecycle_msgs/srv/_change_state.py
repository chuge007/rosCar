...
class Metaclass_ChangeState_Event(type):
    """Metaclass of message 'ChangeState_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__change_state__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__change_state__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__change_state__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__change_state__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__change_state__event
...
class ChangeState_Event(metaclass=Metaclass_ChangeState_Event):
    """Message class 'ChangeState_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<lifecycle_msgs/ChangeState_Request, 1>',
        'response': 'sequence<lifecycle_msgs/ChangeState_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lifecycle_msgs', 'srv'], 'ChangeState_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lifecycle_msgs', 'srv'], 'ChangeState_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from lifecycle_msgs.srv import ChangeState_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ChangeState_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ChangeState_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ChangeState_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ChangeState_Response'"
...
class Metaclass_ChangeState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _change_state.Metaclass_ChangeState_Event._TYPE_SUPPORT is None:
                _change_state.Metaclass_ChangeState_Event.__import_type_support__()
...
class ChangeState(metaclass=Metaclass_ChangeState):
    ...
    from lifecycle_msgs.srv._change_state import ChangeState_Event as Event
