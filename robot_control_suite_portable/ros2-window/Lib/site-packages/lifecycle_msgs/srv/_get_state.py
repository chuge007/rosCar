...
class GetState_Event(metaclass=Metaclass_GetState_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<lifecycle_msgs/GetState_Request, 1>',
        'response': 'sequence<lifecycle_msgs/GetState_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lifecycle_msgs', 'srv'], 'GetState_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['lifecycle_msgs', 'srv'], 'GetState_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from lifecycle_msgs.srv import GetState_Request
    ...
    def response(self, value):
        if self._check_fields:
            from lifecycle_msgs.srv import GetState_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class GetState(metaclass=Metaclass_GetState):
    ...
    from lifecycle_msgs.srv._get_state import GetState_Event as Event
