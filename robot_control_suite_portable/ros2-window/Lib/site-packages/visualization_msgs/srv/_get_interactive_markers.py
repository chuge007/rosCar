...
class Metaclass_GetInteractiveMarkers_Event(type):
    """Metaclass of message 'GetInteractiveMarkers_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_interactive_markers__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_interactive_markers__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_interactive_markers__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_interactive_markers__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_interactive_markers__event
...
class GetInteractiveMarkers_Event(metaclass=Metaclass_GetInteractiveMarkers_Event):
    """Message class 'GetInteractiveMarkers_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<visualization_msgs/GetInteractiveMarkers_Request, 1>',
        'response': 'sequence<visualization_msgs/GetInteractiveMarkers_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['visualization_msgs', 'srv'], 'GetInteractiveMarkers_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['visualization_msgs', 'srv'], 'GetInteractiveMarkers_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from visualization_msgs.srv import GetInteractiveMarkers_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetInteractiveMarkers_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetInteractiveMarkers_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from visualization_msgs.srv import GetInteractiveMarkers_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetInteractiveMarkers_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetInteractiveMarkers_Response'"
...
class Metaclass_GetInteractiveMarkers(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_interactive_markers.Metaclass_GetInteractiveMarkers_Event._TYPE_SUPPORT is None:
                _get_interactive_markers.Metaclass_GetInteractiveMarkers_Event.__import_type_support__()
...
class GetInteractiveMarkers(metaclass=Metaclass_GetInteractiveMarkers):
    ...
    from visualization_msgs.srv._get_interactive_markers import GetInteractiveMarkers_Event as Event
