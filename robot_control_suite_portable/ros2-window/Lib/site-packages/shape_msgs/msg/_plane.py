...
class Metaclass_Plane(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__plane
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__plane
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__plane
            cls._TYPE_SUPPORT = module.type_support_msg__msg__plane
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__plane
...
class Plane(metaclass=Metaclass_Plane):
    """Message class 'Plane'."""
    ...
    def __init__(self, **kwargs):
        ...
        if 'coef' not in kwargs:
            self.coef = numpy.zeros(4, dtype=numpy.float64)
        else:
    ...
    def coef(self, value):
        if self._check_fields:
            if isinstance(value, numpy.ndarray):
                assert value.dtype == numpy.float64, \
                    "The 'coef' numpy.ndarray() must have the dtype of 'numpy.float64'"
                assert value.size == 4, \
                    "The 'coef' numpy.ndarray() must have a size of 4"
                self._coef = value
                return
        ...
        self._coef = numpy.array(value, dtype=numpy.float64)
