...
class Mesh(metaclass=Metaclass_Mesh):
    ...
    _fields_and_field_types = {
        'triangles': 'sequence<shape_msgs/MeshTriangle>',
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['shape_msgs', 'msg'], 'MeshTriangle')),  # noqa: E501
