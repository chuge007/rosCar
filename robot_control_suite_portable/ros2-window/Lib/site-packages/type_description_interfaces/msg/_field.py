...
class Metaclass_Field(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if FieldType.__class__._TYPE_SUPPORT is None:
                FieldType.__class__.__import_type_support__()
...
class Field(metaclass=Metaclass_Field):
    ...
    _fields_and_field_types = {
        'name': 'string',
        'type': 'type_description_interfaces/FieldType',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['type_description_interfaces', 'msg'], 'FieldType'),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from type_description_interfaces.msg import FieldType
        self.type = kwargs.get('type', FieldType())
    ...
    def type(self, value):  # noqa: A003
        if self._check_fields:
            from type_description_interfaces.msg import FieldType
            assert \
                isinstance(value, FieldType), \
                "The 'type' field must be a sub message of type 'FieldType'"
        self._type = value
