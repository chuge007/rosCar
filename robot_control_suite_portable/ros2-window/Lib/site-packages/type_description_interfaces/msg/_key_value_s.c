...
bool type_description_interfaces__msg__key_value__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("type_description_interfaces.msg._key_value.KeyValue", full_classname_dest, 51) == 0);
  }
  type_description_interfaces__msg__KeyValue * ros_message = _ros_message;
  {  // key
...
PyObject * type_description_interfaces__msg__key_value__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("type_description_interfaces.msg._key_value");
  ...
  type_description_interfaces__msg__KeyValue * ros_message = (type_description_interfaces__msg__KeyValue *)raw_ros_message;
  {  // key
    PyObject * field = NULL;
