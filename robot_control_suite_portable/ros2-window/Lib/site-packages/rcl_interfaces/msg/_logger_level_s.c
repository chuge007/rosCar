...
bool rcl_interfaces__msg__logger_level__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.msg._logger_level.LoggerLevel", full_classname_dest, 44) == 0);
  }
  rcl_interfaces__msg__LoggerLevel * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of LoggerLevel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rcl_interfaces.msg._logger_level");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LoggerLevel");
  ...
  rcl_interfaces__msg__LoggerLevel * ros_message = (rcl_interfaces__msg__LoggerLevel *)raw_ros_message;
  {  // name
    PyObject * field = NULL;
