...
bool rcl_interfaces__msg__set_logger_levels_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.msg._set_logger_levels_result.SetLoggerLevelsResult", full_classname_dest, 66) == 0);
  }
  rcl_interfaces__msg__SetLoggerLevelsResult * ros_message = _ros_message;
  {  // successful
...
{
  /* NOTE(esteve): Call constructor of SetLoggerLevelsResult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rcl_interfaces.msg._set_logger_levels_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetLoggerLevelsResult");
  ...
  rcl_interfaces__msg__SetLoggerLevelsResult * ros_message = (rcl_interfaces__msg__SetLoggerLevelsResult *)raw_ros_message;
  {  // successful
    PyObject * field = NULL;
