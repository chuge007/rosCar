...
class Metaclass_DescribeParameters_Event(type):
    """Metaclass of message 'DescribeParameters_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__describe_parameters__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__describe_parameters__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__describe_parameters__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__describe_parameters__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__describe_parameters__event
...
class DescribeParameters_Event(metaclass=Metaclass_DescribeParameters_Event):
    """Message class 'DescribeParameters_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rcl_interfaces/DescribeParameters_Request, 1>',
        'response': 'sequence<rcl_interfaces/DescribeParameters_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rcl_interfaces', 'srv'], 'DescribeParameters_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rcl_interfaces', 'srv'], 'DescribeParameters_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rcl_interfaces.srv import DescribeParameters_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, DescribeParameters_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'DescribeParameters_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rcl_interfaces.srv import DescribeParameters_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, DescribeParameters_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'DescribeParameters_Response'"
...
class Metaclass_DescribeParameters(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _describe_parameters.Metaclass_DescribeParameters_Event._TYPE_SUPPORT is None:
                _describe_parameters.Metaclass_DescribeParameters_Event.__import_type_support__()
...
class DescribeParameters(metaclass=Metaclass_DescribeParameters):
    ...
    from rcl_interfaces.srv._describe_parameters import DescribeParameters_Event as Event
