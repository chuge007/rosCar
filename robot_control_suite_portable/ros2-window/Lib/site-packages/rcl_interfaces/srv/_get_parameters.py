...
class GetParameters_Response(metaclass=Metaclass_GetParameters_Response):
    ...
    _fields_and_field_types = {
        'values': 'sequence<rcl_interfaces/ParameterValue>',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rcl_interfaces', 'msg'], 'ParameterValue')),  # noqa: E501
    )
...
class Metaclass_GetParameters_Event(type):
    """Metaclass of message 'GetParameters_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_parameters__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_parameters__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_parameters__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_parameters__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_parameters__event
...
class GetParameters_Event(metaclass=Metaclass_GetParameters_Event):
    """Message class 'GetParameters_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rcl_interfaces/GetParameters_Request, 1>',
        'response': 'sequence<rcl_interfaces/GetParameters_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rcl_interfaces', 'srv'], 'GetParameters_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rcl_interfaces', 'srv'], 'GetParameters_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rcl_interfaces.srv import GetParameters_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetParameters_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetParameters_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetParameters_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetParameters_Response'"
...
class Metaclass_GetParameters(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rcl_interfaces.srv import _get_parameters
            ...
            if _get_parameters.Metaclass_GetParameters_Event._TYPE_SUPPORT is None:
                _get_parameters.Metaclass_GetParameters_Event.__import_type_support__()


class GetParameters(metaclass=Metaclass_GetParameters):
    from rcl_interfaces.srv._get_parameters import GetParameters_Request as Request
    from rcl_interfaces.srv._get_parameters import GetParameters_Response as Response
    from rcl_interfaces.srv._get_parameters import GetParameters_Event as Event
