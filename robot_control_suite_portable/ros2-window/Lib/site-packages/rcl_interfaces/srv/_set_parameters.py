...
class Metaclass_SetParameters_Event(type):
    """Metaclass of message 'SetParameters_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_parameters__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_parameters__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_parameters__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_parameters__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_parameters__event
...
class SetParameters_Event(metaclass=Metaclass_SetParameters_Event):
    """Message class 'SetParameters_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rcl_interfaces/SetParameters_Request, 1>',
        'response': 'sequence<rcl_interfaces/SetParameters_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rcl_interfaces', 'srv'], 'SetParameters_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rcl_interfaces', 'srv'], 'SetParameters_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rcl_interfaces.srv import SetParameters_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetParameters_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetParameters_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetParameters_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetParameters_Response'"
...
class Metaclass_SetParameters(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_parameters.Metaclass_SetParameters_Event._TYPE_SUPPORT is None:
                _set_parameters.Metaclass_SetParameters_Event.__import_type_support__()
...
class SetParameters(metaclass=Metaclass_SetParameters):
    ...
    from rcl_interfaces.srv._set_parameters import SetParameters_Event as Event
