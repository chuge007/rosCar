...
class Metaclass_GetParameterTypes_Event(type):
    """Metaclass of message 'GetParameterTypes_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_parameter_types__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_parameter_types__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_parameter_types__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_parameter_types__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_parameter_types__event
...
class GetParameterTypes_Event(metaclass=Metaclass_GetParameterTypes_Event):
    """Message class 'GetParameterTypes_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rcl_interfaces/GetParameterTypes_Request, 1>',
        'response': 'sequence<rcl_interfaces/GetParameterTypes_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rcl_interfaces', 'srv'], 'GetParameterTypes_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rcl_interfaces', 'srv'], 'GetParameterTypes_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rcl_interfaces.srv import GetParameterTypes_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetParameterTypes_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetParameterTypes_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rcl_interfaces.srv import GetParameterTypes_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetParameterTypes_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetParameterTypes_Response'"
...
class Metaclass_GetParameterTypes(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_parameter_types.Metaclass_GetParameterTypes_Event._TYPE_SUPPORT is None:
                _get_parameter_types.Metaclass_GetParameterTypes_Event.__import_type_support__()
...
class GetParameterTypes(metaclass=Metaclass_GetParameterTypes):
    ...
    from rcl_interfaces.srv._get_parameter_types import GetParameterTypes_Event as Event
