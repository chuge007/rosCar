...
class Metaclass_BoundedPlainSequences(type):
    """Metaclass of message 'BoundedPlainSequences'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__bounded_plain_sequences
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__bounded_plain_sequences
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__bounded_plain_sequences
            cls._TYPE_SUPPORT = module.type_support_msg__msg__bounded_plain_sequences
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__bounded_plain_sequences
...
class BoundedPlainSequences(metaclass=Metaclass_BoundedPlainSequences):
    """Message class 'BoundedPlainSequences'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.bool_values_default = kwargs.get(
            'bool_values_default', BoundedPlainSequences.BOOL_VALUES_DEFAULT__DEFAULT)
        self.byte_values_default = kwargs.get(
            'byte_values_default', BoundedPlainSequences.BYTE_VALUES_DEFAULT__DEFAULT)
        self.char_values_default = kwargs.get(
            'char_values_default', BoundedPlainSequences.CHAR_VALUES_DEFAULT__DEFAULT)
        self.float32_values_default = kwargs.get(
            'float32_values_default', BoundedPlainSequences.FLOAT32_VALUES_DEFAULT__DEFAULT)
        self.float64_values_default = kwargs.get(
            'float64_values_default', BoundedPlainSequences.FLOAT64_VALUES_DEFAULT__DEFAULT)
        self.int8_values_default = kwargs.get(
            'int8_values_default', BoundedPlainSequences.INT8_VALUES_DEFAULT__DEFAULT)
        self.uint8_values_default = kwargs.get(
            'uint8_values_default', BoundedPlainSequences.UINT8_VALUES_DEFAULT__DEFAULT)
        self.int16_values_default = kwargs.get(
            'int16_values_default', BoundedPlainSequences.INT16_VALUES_DEFAULT__DEFAULT)
        self.uint16_values_default = kwargs.get(
            'uint16_values_default', BoundedPlainSequences.UINT16_VALUES_DEFAULT__DEFAULT)
        self.int32_values_default = kwargs.get(
            'int32_values_default', BoundedPlainSequences.INT32_VALUES_DEFAULT__DEFAULT)
        self.uint32_values_default = kwargs.get(
            'uint32_values_default', BoundedPlainSequences.UINT32_VALUES_DEFAULT__DEFAULT)
        self.int64_values_default = kwargs.get(
            'int64_values_default', BoundedPlainSequences.INT64_VALUES_DEFAULT__DEFAULT)
        self.uint64_values_default = kwargs.get(
            'uint64_values_default', BoundedPlainSequences.UINT64_VALUES_DEFAULT__DEFAULT)
