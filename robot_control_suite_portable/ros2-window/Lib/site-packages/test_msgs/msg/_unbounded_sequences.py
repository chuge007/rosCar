...
class UnboundedSequences(metaclass=Metaclass_UnboundedSequences):
    ...
    _fields_and_field_types = {
        ...
        'basic_types_values': 'sequence<test_msgs/BasicTypes>',
        'constants_values': 'sequence<test_msgs/Constants>',
        'defaults_values': 'sequence<test_msgs/Defaults>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['test_msgs', 'msg'], 'BasicTypes')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['test_msgs', 'msg'], 'Constants')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['test_msgs', 'msg'], 'Defaults')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.BasicType('boolean')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.BasicType('octet')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.BasicType('uint8')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.BasicType('float')),  # noqa: E501
    ...
    def float32_values(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'float32_values' field must be a set or sequence and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
    ...
    def float64_values(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'float64_values' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -3.402823466e+38 or val > 3.402823466e+38) or math.isinf(val) for val in value)), \
                "The 'float32_values_default' field must be a set or sequence and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'float64_values_default' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
