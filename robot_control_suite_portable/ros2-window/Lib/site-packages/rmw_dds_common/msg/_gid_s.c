...
bool rmw_dds_common__msg__gid__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmw_dds_common.msg._gid.Gid", full_classname_dest, 27) == 0);
  }
  rmw_dds_common__msg__Gid * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of Gid */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmw_dds_common.msg._gid");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Gid");
  ...
  rmw_dds_common__msg__Gid * ros_message = (rmw_dds_common__msg__Gid *)raw_ros_message;
  {  // data
    PyObject * field = NULL;
