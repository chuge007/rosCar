...
class Metaclass_ProjectedMapsInfo_Event(type):
    """Metaclass of message 'ProjectedMapsInfo_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__projected_maps_info__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__projected_maps_info__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__projected_maps_info__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__projected_maps_info__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__projected_maps_info__event
...
class ProjectedMapsInfo_Event(metaclass=Metaclass_ProjectedMapsInfo_Event):
    """Message class 'ProjectedMapsInfo_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<map_msgs/ProjectedMapsInfo_Request, 1>',
        'response': 'sequence<map_msgs/ProjectedMapsInfo_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['map_msgs', 'srv'], 'ProjectedMapsInfo_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['map_msgs', 'srv'], 'ProjectedMapsInfo_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from map_msgs.srv import ProjectedMapsInfo_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ProjectedMapsInfo_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ProjectedMapsInfo_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from map_msgs.srv import ProjectedMapsInfo_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ProjectedMapsInfo_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ProjectedMapsInfo_Response'"
...
class Metaclass_ProjectedMapsInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _projected_maps_info.Metaclass_ProjectedMapsInfo_Event._TYPE_SUPPORT is None:
                _projected_maps_info.Metaclass_ProjectedMapsInfo_Event.__import_type_support__()
...
class ProjectedMapsInfo(metaclass=Metaclass_ProjectedMapsInfo):
    ...
    from map_msgs.srv._projected_maps_info import ProjectedMapsInfo_Event as Event
