...
ROSIDL_GENERATOR_C_EXPORT
bool map_msgs__srv__get_point_map_roi__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("map_msgs.srv._get_point_map_roi.GetPointMapROI_Event", full_classname_dest, 52) == 0);
  }
  map_msgs__srv__GetPointMapROI_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!map_msgs__srv__GetPointMapROI_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create map_msgs__srv__GetPointMapROI_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    map_msgs__srv__GetPointMapROI_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!map_msgs__srv__get_point_map_roi__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!map_msgs__srv__GetPointMapROI_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create map_msgs__srv__GetPointMapROI_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    map_msgs__srv__GetPointMapROI_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!map_msgs__srv__get_point_map_roi__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * map_msgs__srv__get_point_map_roi__event__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of GetPointMapROI_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("map_msgs.srv._get_point_map_roi");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetPointMapROI_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  map_msgs__srv__GetPointMapROI_Event * ros_message = (map_msgs__srv__GetPointMapROI_Event *)raw_ros_message;
  {  // info
    PyObject * field = NULL;
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = map_msgs__srv__get_point_map_roi__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = map_msgs__srv__get_point_map_roi__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
