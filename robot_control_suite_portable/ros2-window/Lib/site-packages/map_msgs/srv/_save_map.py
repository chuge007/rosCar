...
class SaveMap_Event(metaclass=Metaclass_SaveMap_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<map_msgs/SaveMap_Request, 1>',
        'response': 'sequence<map_msgs/SaveMap_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['map_msgs', 'srv'], 'SaveMap_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['map_msgs', 'srv'], 'SaveMap_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from map_msgs.srv import SaveMap_Request
    ...
    def response(self, value):
        if self._check_fields:
            from map_msgs.srv import SaveMap_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_SaveMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from map_msgs.srv import _save_map
...
class SaveMap(metaclass=Metaclass_SaveMap):
    from map_msgs.srv._save_map import SaveMap_Request as Request
    from map_msgs.srv._save_map import SaveMap_Response as Response
    from map_msgs.srv._save_map import SaveMap_Event as Event
