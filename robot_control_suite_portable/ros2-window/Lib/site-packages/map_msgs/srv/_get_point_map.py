...
class Metaclass_GetPointMap_Event(type):
    """Metaclass of message 'GetPointMap_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_point_map__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_point_map__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_point_map__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_point_map__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_point_map__event
...
class GetPointMap_Event(metaclass=Metaclass_GetPointMap_Event):
    """Message class 'GetPointMap_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<map_msgs/GetPointMap_Request, 1>',
        'response': 'sequence<map_msgs/GetPointMap_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['map_msgs', 'srv'], 'GetPointMap_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['map_msgs', 'srv'], 'GetPointMap_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from map_msgs.srv import GetPointMap_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetPointMap_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetPointMap_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from map_msgs.srv import GetPointMap_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetPointMap_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetPointMap_Response'"
...
class Metaclass_GetPointMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_point_map.Metaclass_GetPointMap_Event._TYPE_SUPPORT is None:
                _get_point_map.Metaclass_GetPointMap_Event.__import_type_support__()
...
class GetPointMap(metaclass=Metaclass_GetPointMap):
    ...
    from map_msgs.srv._get_point_map import GetPointMap_Event as Event
