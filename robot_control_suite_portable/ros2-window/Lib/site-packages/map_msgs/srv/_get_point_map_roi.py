...
class GetPointMapROI_Request(metaclass=Metaclass_GetPointMapROI_Request):
    ...
    def l_z(self, value):
        if self._check_fields:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'l_z' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._l_z = value
...
class Metaclass_GetPointMapROI_Event(type):
    """Metaclass of message 'GetPointMapROI_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_point_map_roi__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_point_map_roi__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_point_map_roi__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_point_map_roi__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_point_map_roi__event
...
class GetPointMapROI_Event(metaclass=Metaclass_GetPointMapROI_Event):
    """Message class 'GetPointMapROI_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<map_msgs/GetPointMapROI_Request, 1>',
        'response': 'sequence<map_msgs/GetPointMapROI_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['map_msgs', 'srv'], 'GetPointMapROI_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['map_msgs', 'srv'], 'GetPointMapROI_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from map_msgs.srv import GetPointMapROI_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetPointMapROI_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetPointMapROI_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from map_msgs.srv import GetPointMapROI_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetPointMapROI_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetPointMapROI_Response'"
...
class Metaclass_GetPointMapROI(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_point_map_roi.Metaclass_GetPointMapROI_Event._TYPE_SUPPORT is None:
                _get_point_map_roi.Metaclass_GetPointMapROI_Event.__import_type_support__()
...
class GetPointMapROI(metaclass=Metaclass_GetPointMapROI):
    ...
    from map_msgs.srv._get_point_map_roi import GetPointMapROI_Event as Event
