...
class AddTwoInts_Event(metaclass=Metaclass_AddTwoInts_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<example_interfaces/AddTwoInts_Request, 1>',
        'response': 'sequence<example_interfaces/AddTwoInts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['example_interfaces', 'srv'], 'AddTwoInts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['example_interfaces', 'srv'], 'AddTwoInts_Response'), 1),  # noqa: E501
    )
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    ...
    from example_interfaces.srv._add_two_ints import AddTwoInts_Event as Event
