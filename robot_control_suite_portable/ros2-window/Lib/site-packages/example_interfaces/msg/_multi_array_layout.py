...
class Metaclass_MultiArrayLayout(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from example_interfaces.msg import MultiArrayDimension
...
class MultiArrayLayout(metaclass=Metaclass_MultiArrayLayout):
    ...
    _fields_and_field_types = {
        'dim': 'sequence<example_interfaces/MultiArrayDimension>',
        'data_offset': 'uint32',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['example_interfaces', 'msg'], 'MultiArrayDimension')),  # noqa: E501
