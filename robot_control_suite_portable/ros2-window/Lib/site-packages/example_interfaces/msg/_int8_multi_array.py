...
class Metaclass_Int8MultiArray(type):
    """Metaclass of message 'Int8MultiArray'."""
...
class Int8MultiArray(metaclass=Metaclass_Int8MultiArray):
    """Message class 'Int8MultiArray'."""
