...
class Metaclass_JointTrajectoryPoint(type):
    """Metaclass of message 'JointTrajectoryPoint'."""
...
class JointTrajectoryPoint(metaclass=Metaclass_JointTrajectoryPoint):
    """Message class 'JointTrajectoryPoint'."""
