...
class Metaclass_JointTrajectory(type):
    """Metaclass of message 'JointTrajectory'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__joint_trajectory
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__joint_trajectory
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__joint_trajectory
            cls._TYPE_SUPPORT = module.type_support_msg__msg__joint_trajectory
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__joint_trajectory
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'points' field must be a set or sequence and each value of type 'JointTrajectoryPoint'"
        self._points = value
