...
class GoalStatusArray(metaclass=Metaclass_GoalStatusArray):
    ...
    _fields_and_field_types = {
        ...
        'status_list': 'sequence<actionlib_msgs/GoalStatus>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['actionlib_msgs', 'msg'], 'GoalStatus')),  # noqa: E501
    )
