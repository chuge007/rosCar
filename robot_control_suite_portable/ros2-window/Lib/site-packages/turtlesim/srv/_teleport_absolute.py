...
class Metaclass_TeleportAbsolute_Event(type):
...
class TeleportAbsolute_Event(metaclass=Metaclass_TeleportAbsolute_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<turtlesim/TeleportAbsolute_Request, 1>',
        'response': 'sequence<turtlesim/TeleportAbsolute_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['turtlesim', 'srv'], 'TeleportAbsolute_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['turtlesim', 'srv'], 'TeleportAbsolute_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from turtlesim.srv import TeleportAbsolute_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'TeleportAbsolute_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from turtlesim.srv import TeleportAbsolute_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'TeleportAbsolute_Response'"
...
class TeleportAbsolute(metaclass=Metaclass_TeleportAbsolute):
    ...
    from turtlesim.srv._teleport_absolute import TeleportAbsolute_Event as Event
