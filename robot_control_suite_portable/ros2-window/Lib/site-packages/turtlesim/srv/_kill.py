...
class Kill_Event(metaclass=Metaclass_Kill_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<turtlesim/Kill_Request, 1>',
        'response': 'sequence<turtlesim/Kill_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['turtlesim', 'srv'], 'Kill_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['turtlesim', 'srv'], 'Kill_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from turtlesim.srv import Kill_Request
    ...
    def response(self, value):
        if self._check_fields:
            from turtlesim.srv import Kill_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Kill(metaclass=Metaclass_Kill):
    ...
    from turtlesim.srv._kill import Kill_Event as Event
