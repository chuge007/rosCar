...
class Spawn_Event(metaclass=Metaclass_Spawn_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<turtlesim/Spawn_Request, 1>',
        'response': 'sequence<turtlesim/Spawn_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['turtlesim', 'srv'], 'Spawn_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['turtlesim', 'srv'], 'Spawn_Response'), 1),  # noqa: E501
    )
...
class Spawn(metaclass=Metaclass_Spawn):
    ...
    from turtlesim.srv._spawn import Spawn_Event as Event
