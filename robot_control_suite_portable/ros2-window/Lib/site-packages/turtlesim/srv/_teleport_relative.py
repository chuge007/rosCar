...
class TeleportRelative_Event(metaclass=Metaclass_TeleportRelative_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<turtlesim/TeleportRelative_Request, 1>',
        'response': 'sequence<turtlesim/TeleportRelative_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['turtlesim', 'srv'], 'TeleportRelative_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['turtlesim', 'srv'], 'TeleportRelative_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from turtlesim.srv import TeleportRelative_Request
    ...
    def response(self, value):
        if self._check_fields:
            from turtlesim.srv import TeleportRelative_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class TeleportRelative(metaclass=Metaclass_TeleportRelative):
    ...
    from turtlesim.srv._teleport_relative import TeleportRelative_Event as Event
