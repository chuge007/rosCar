...
class Metaclass_FrameGraph_Event(type):
    """Metaclass of message 'FrameGraph_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__frame_graph__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__frame_graph__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__frame_graph__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__frame_graph__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__frame_graph__event
...
class FrameGraph_Event(metaclass=Metaclass_FrameGraph_Event):
    """Message class 'FrameGraph_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<tf2_msgs/FrameGraph_Request, 1>',
        'response': 'sequence<tf2_msgs/FrameGraph_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tf2_msgs', 'srv'], 'FrameGraph_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tf2_msgs', 'srv'], 'FrameGraph_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from tf2_msgs.srv import FrameGraph_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, FrameGraph_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'FrameGraph_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from tf2_msgs.srv import FrameGraph_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, FrameGraph_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'FrameGraph_Response'"
...
class Metaclass_FrameGraph(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _frame_graph.Metaclass_FrameGraph_Event._TYPE_SUPPORT is None:
                _frame_graph.Metaclass_FrameGraph_Event.__import_type_support__()
...
class FrameGraph(metaclass=Metaclass_FrameGraph):
    ...
    from tf2_msgs.srv._frame_graph import FrameGraph_Event as Event
