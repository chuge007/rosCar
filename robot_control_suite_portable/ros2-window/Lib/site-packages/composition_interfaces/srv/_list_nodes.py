...
class Metaclass_ListNodes_Event(type):
    """Metaclass of message 'ListNodes_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__list_nodes__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__list_nodes__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__list_nodes__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__list_nodes__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__list_nodes__event
...
class ListNodes_Event(metaclass=Metaclass_ListNodes_Event):
    """Message class 'ListNodes_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<composition_interfaces/ListNodes_Request, 1>',
        'response': 'sequence<composition_interfaces/ListNodes_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['composition_interfaces', 'srv'], 'ListNodes_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['composition_interfaces', 'srv'], 'ListNodes_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from composition_interfaces.srv import ListNodes_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListNodes_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ListNodes_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from composition_interfaces.srv import ListNodes_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListNodes_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ListNodes_Response'"
...
class Metaclass_ListNodes(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _list_nodes.Metaclass_ListNodes_Event._TYPE_SUPPORT is None:
                _list_nodes.Metaclass_ListNodes_Event.__import_type_support__()
...
class ListNodes(metaclass=Metaclass_ListNodes):
    ...
    from composition_interfaces.srv._list_nodes import ListNodes_Event as Event
