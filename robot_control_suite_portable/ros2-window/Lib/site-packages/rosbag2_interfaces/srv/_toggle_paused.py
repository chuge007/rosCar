...
class Metaclass_TogglePaused_Event(type):
    """Metaclass of message 'TogglePaused_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__toggle_paused__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__toggle_paused__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__toggle_paused__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__toggle_paused__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__toggle_paused__event
...
class TogglePaused_Event(metaclass=Metaclass_TogglePaused_Event):
    """Message class 'TogglePaused_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rosbag2_interfaces/TogglePaused_Request, 1>',
        'response': 'sequence<rosbag2_interfaces/TogglePaused_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosbag2_interfaces', 'srv'], 'TogglePaused_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosbag2_interfaces', 'srv'], 'TogglePaused_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rosbag2_interfaces.srv import TogglePaused_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, TogglePaused_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'TogglePaused_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rosbag2_interfaces.srv import TogglePaused_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, TogglePaused_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'TogglePaused_Response'"
...
class Metaclass_TogglePaused(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _toggle_paused.Metaclass_TogglePaused_Event._TYPE_SUPPORT is None:
                _toggle_paused.Metaclass_TogglePaused_Event.__import_type_support__()
...
class TogglePaused(metaclass=Metaclass_TogglePaused):
    ...
    from rosbag2_interfaces.srv._toggle_paused import TogglePaused_Event as Event
