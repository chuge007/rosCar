...
class Metaclass_Seek_Event(type):
    """Metaclass of message 'Seek_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__seek__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__seek__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__seek__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__seek__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__seek__event
...
class Seek_Event(metaclass=Metaclass_Seek_Event):
    """Message class 'Seek_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rosbag2_interfaces/Seek_Request, 1>',
        'response': 'sequence<rosbag2_interfaces/Seek_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosbag2_interfaces', 'srv'], 'Seek_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rosbag2_interfaces', 'srv'], 'Seek_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rosbag2_interfaces.srv import Seek_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, Seek_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Seek_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rosbag2_interfaces.srv import Seek_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Seek_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Seek_Response'"
...
class Metaclass_Seek(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rosbag2_interfaces.srv import _seek
            ...
            if _seek.Metaclass_Seek_Event._TYPE_SUPPORT is None:
                _seek.Metaclass_Seek_Event.__import_type_support__()


class Seek(metaclass=Metaclass_Seek):
    from rosbag2_interfaces.srv._seek import Seek_Request as Request
    from rosbag2_interfaces.srv._seek import Seek_Response as Response
    from rosbag2_interfaces.srv._seek import Seek_Event as Event
