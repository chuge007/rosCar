...
bool rosbag2_interfaces__msg__write_split_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosbag2_interfaces.msg._write_split_event.WriteSplitEvent", full_classname_dest, 57) == 0);
  }
  rosbag2_interfaces__msg__WriteSplitEvent * ros_message = _ros_message;
  {  // closed_file
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * rosbag2_interfaces__msg__write_split_event__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of WriteSplitEvent */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosbag2_interfaces.msg._write_split_event");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WriteSplitEvent");
  ...
  rosbag2_interfaces__msg__WriteSplitEvent * ros_message = (rosbag2_interfaces__msg__WriteSplitEvent *)raw_ros_message;
  {  // closed_file
    PyObject * field = NULL;
