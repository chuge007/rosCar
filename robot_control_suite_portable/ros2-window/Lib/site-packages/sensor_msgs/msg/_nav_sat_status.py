...
class Metaclass_NavSatStatus(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'SERVICE_UNKNOWN': cls.__constants['SERVICE_UNKNOWN'],
    ...
    def STATUS_UNKNOWN(self):
        ...
        return Metaclass_NavSatStatus.__constants['STATUS_UNKNOWN']
    ...
    @property
    def SERVICE_UNKNOWN(self):
        """Message constant 'SERVICE_UNKNOWN'."""
        return Metaclass_NavSatStatus.__constants['SERVICE_UNKNOWN']
...
class NavSatStatus(metaclass=Metaclass_NavSatStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.status = kwargs.get(
            'status', NavSatStatus.STATUS__DEFAULT)
