...
class PointCloud(metaclass=Metaclass_PointCloud):
    ...
    _fields_and_field_types = {
        ...
        'channels': 'sequence<sensor_msgs/ChannelFloat32>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['sensor_msgs', 'msg'], 'ChannelFloat32')),  # noqa: E501
    )
