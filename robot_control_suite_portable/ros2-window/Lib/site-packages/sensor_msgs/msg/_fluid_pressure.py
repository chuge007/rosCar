...
class Metaclass_FluidPressure(type):
    """Metaclass of message 'FluidPressure'."""
...
class FluidPressure(metaclass=Metaclass_FluidPressure):
    """Message class 'FluidPressure'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.fluid_pressure = kwargs.get('fluid_pressure', float())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.fluid_pressure != other.fluid_pressure:
            return False
    ...
    def fluid_pressure(self):
        """Message field 'fluid_pressure'."""
        return self._fluid_pressure

    @fluid_pressure.setter
    def fluid_pressure(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'fluid_pressure' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'fluid_pressure' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._fluid_pressure = value
