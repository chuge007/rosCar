...
bool crawling_robot_interfaces__msg__can_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("crawling_robot_interfaces.msg._can_frame.CanFrame", full_classname_dest, 49) == 0);
  }
  crawling_robot_interfaces__msg__CanFrame * ros_message = _ros_message;
  {  // header
...
PyObject * crawling_robot_interfaces__msg__can_frame__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("crawling_robot_interfaces.msg._can_frame");
