  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x5e, 0xcf, 0x3e, 0x8a, 0xa8, 0xf5, 0x05, 0x7d,
      0xa8, 0xe6, 0x14, 0x28, 0x69, 0x11, 0x2b, 0x49,
      0x14, 0x26, 0xa4, 0x0b, 0xed, 0x68, 0x93, 0xa7,
      0x8e, 0x23, 0x51, 0x34, 0x28, 0x96, 0xf8, 0x13,
    }};
  return &hash;
}
...
static char crawling_robot_interfaces__msg__LaserProfile__TYPE_NAME[] = "crawling_robot_interfaces/msg/LaserProfile";
...
static char crawling_robot_interfaces__msg__LaserProfile__FIELD_NAME__header[] = "header";
static char crawling_robot_interfaces__msg__LaserProfile__FIELD_NAME__points[] = "points";
static char crawling_robot_interfaces__msg__LaserProfile__FIELD_NAME__encoder_ticks[] = "encoder_ticks";

static rosidl_runtime_c__type_description__Field crawling_robot_interfaces__msg__LaserProfile__FIELDS[] = {
  {
    {crawling_robot_interfaces__msg__LaserProfile__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {crawling_robot_interfaces__msg__LaserProfile__FIELD_NAME__points, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {crawling_robot_interfaces__msg__LaserProfile__FIELD_NAME__encoder_ticks, 13, 13},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription crawling_robot_interfaces__msg__LaserProfile__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {crawling_robot_interfaces__msg__LaserProfile__TYPE_NAME, 42, 42},
      {crawling_robot_interfaces__msg__LaserProfile__FIELDS, 3, 3},
    },
    {crawling_robot_interfaces__msg__LaserProfile__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
...
crawling_robot_interfaces__msg__LaserProfile__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *crawling_robot_interfaces__msg__LaserProfile__get_individual_type_description_source(NULL),
