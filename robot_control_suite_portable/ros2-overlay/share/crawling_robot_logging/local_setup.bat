...
set "AMENT_ENVIRONMENT_HOOKS[crawling_robot_logging]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[crawling_robot_logging] "%AMENT_CURRENT_PREFIX%\share\crawling_robot_logging\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[crawling_robot_logging] "%AMENT_CURRENT_PREFIX%\share\crawling_robot_logging\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[crawling_robot_logging]:;=";"%") do (
    call:call_file %%f
  )
