...
set "AMENT_ENVIRONMENT_HOOKS[crawling_robot_drivers]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[crawling_robot_drivers] "%AMENT_CURRENT_PREFIX%\share\crawling_robot_drivers\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[crawling_robot_drivers] "%AMENT_CURRENT_PREFIX%\share\crawling_robot_drivers\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[crawling_robot_drivers]:;=";"%") do (
    call:call_file %%f
  )
