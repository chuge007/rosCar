...
set "AMENT_ENVIRONMENT_HOOKS[crawling_robot_control]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[crawling_robot_control] "%AMENT_CURRENT_PREFIX%\share\crawling_robot_control\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[crawling_robot_control] "%AMENT_CURRENT_PREFIX%\share\crawling_robot_control\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[crawling_robot_control]:;=";"%") do (
    call:call_file %%f
  )
