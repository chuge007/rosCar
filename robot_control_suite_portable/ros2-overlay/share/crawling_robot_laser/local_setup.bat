...
set "AMENT_ENVIRONMENT_HOOKS[crawling_robot_laser]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[crawling_robot_laser] "%AMENT_CURRENT_PREFIX%\share\crawling_robot_laser\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[crawling_robot_laser] "%AMENT_CURRENT_PREFIX%\share\crawling_robot_laser\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[crawling_robot_laser]:;=";"%") do (
    call:call_file %%f
  )
